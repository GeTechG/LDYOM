...
void Logger::Init() {
	...
	defaultConf.set(el::Level::Error, el::ConfigurationType::Format,
	                "%datetime [%logger] %fbase:%func:%line %thread | %msg");
	...
	luaConf.setGlobally(el::ConfigurationType::Format, "%datetime [%logger] : %msg");
	luaConf.set(el::Level::Error, el::ConfigurationType::Format,
	            "%datetime [%logger] %fbase:%func:%line %thread | %msg");
