...
void bindKillFrenzy(sol::state &state) {
  ...
  table.set_function("start",
                     [](const char *_text, const int &_weaponType, const int &_timeInMs, const int &_targetsNum,
                       ...
                       Command<0x01F9>(_text, _weaponType, _timeInMs, _targetsNum, _targetModel1, _targetModel2,
                                       _targetModel3, _targetModel4, _betaSoundsAndMessages);
                     });
