...
void bindObject(sol::state &state) {
  ...
  table.set_function("rotate",
                     [](const int &_self, const float &_fromAngle, const float &_toAngle, const bool &_collisionCheck) {
  ...
  table.set_function("makeTargetable", [](const int &_self, const bool &_state) { Command<0x035D>(_self, _state); });
  ...
  table.set_function("setCollision", [](const int &_self, const bool &_state) { Command<0x0382>(_self, _state); });
  ...
  table.set_function("setDynamic", [](const int &_self, const bool &_state) { Command<0x0392>(_self, _state); });
  ...
  table.set_function("setDrawLast", [](const int &_self, const bool &_state) { Command<0x0418>(_self, _state); });
  ...
  table.set_function("setRecordsCollisions",
                     [](const int &_self, const bool &_state) { Command<0x04D9>(_self, _state); });
  ...
  table.set_function("freezePosition", [](const int &_self, const bool &_state) { Command<0x0550>(_self, _state); });
  ...
  table.set_function("setRenderScorched", [](const int &_self, const bool &_state) { Command<0x0654>(_self, _state); });
  ...
  table.set_function("detach",
                     [](const int &_self, const float &_x, const float &_y, const float &_z,
                        const bool &_collisionDetection) { Command<0x0682>(_self, _x, _y, _z, _collisionDetection); });
  ...
  table.set_function("setVisible", [](const int &_self, const bool &_state) { Command<0x0750>(_self, _state); });
  table.set_function("playAnim", [](const int &_self, const char *_animationName, const char *_animationFile,
                                    const float &_frameDelta, const bool &_lockF, const bool &_loop) {
  ...
  table.set_function("setCollisionDamageEffect",
                     [](const int &_self, const bool &_state) { Command<0x07F7>(_self, _state); });
  ...
  table.set_function("setOnlyDamagedByPlayer",
                     [](const int &_self, const bool &_state) { Command<0x0875>(_self, _state); });
  ...
  table.set_function("setAsStealable", [](const int &_self, const bool &_state) { Command<0x08E9>(_self, _state); });
  ...
  table.set_function("lockDoor", [](const int &_self, const bool &_state) { Command<0x0905>(_self, _state); });
  ...
  table.set_function("winchCanPickUp", [](const int &_self, const bool &_state) { Command<0x0916>(_self, _state); });
  ...
  table.set_function("enableDisabledAttractors",
                     [](const int &_self, const bool &_state) { Command<0x0A0A>(_self, _state); });
  ...
  table.set_function("createNoSave", [](const int &_modelId, const float &_x, const float &_y, const float &_z,
                                        const bool &_useOffset, const bool &_useGround) {
    int handle_;
  ...
  table.set_function("getProofs", [](const int &_self) {
    ...
    bool collision_;
    bool melee_;
    Command<0x0EAE>(_self, (int *)&bullet_, (int *)&fire_, (int *)&explosion_, (int *)&collision_, (int *)&melee_);
