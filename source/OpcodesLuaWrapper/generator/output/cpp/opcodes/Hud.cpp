...
void bindHud(sol::state &state) {
  ...
  table.set_function("switchWidescreen", [](const bool &_state) { Command<0x02A3>(_state); });
  ...
  table.set_function("freezeTimer", [](const bool &_state) { Command<0x0396>(_state); });
  table.set_function("displayTimerWithString", [](const int &_timer, const int &_direction, const char *_text) {
    Command<0x03C3>(_timer, _direction, _text);
  });
  table.set_function("displayCounterWithString", [](const int &_counter, const int &_display, const char *_text) {
    Command<0x03C4>(_counter, _display, _text);
  });
  table.set_function("setSpritesDrawBeforeFade", [](const bool &_state) { Command<0x03E3>(_state); });
  table.set_function("flashObject", [](const int &_object) { Command<0x03E7>(_object); });
  table.set_function("displayNthCounterWithString",
                     [](const int &_counter, const int &_display, const int &_slot, const char *_text) {
                       Command<0x04F7>(_counter, _display, _slot, _text);
                     });
  table.set_function("displayRadar", [](const bool &_state) { Command<0x0581>(_state); });
  table.set_function("setCounterFlashWhenFirstDisplayed",
                     [](const int &_counter, const bool &_state) { Command<0x059C>(_counter, _state); });
  ...
  table.set_function("display", [](const bool &_state) { Command<0x0826>(_state); });
  ...
  table.set_function("drawWindow", [](const float &_leftTopX, const float &_leftTopY, const float &_rightBottomX,
                                      const float &_rightBottomY, const char *_header, const int &_zIndex) {
    Command<0x0937>(_leftTopX, _leftTopY, _rightBottomX, _rightBottomY, _header, _zIndex);
  });
  table.set_function("drawCrosshair", [](const bool &_state) { Command<0x09A3>(_state); });
  table.set_function("displayCarNames", [](const bool &_state) { Command<0x09B9>(_state); });
  table.set_function("displayZoneNames", [](const bool &_state) { Command<0x09BA>(_state); });
  table.set_function("forceBigMessageAndCounter", [](const bool &_state) { Command<0x09EE>(_state); });
  ...
  table.set_function("displayTimerWithStringLocal", [](const int &_timer, const int &_direction, const char *_text) {
  ...
  table.set_function("displayCounterWithStringLocal", [](const int &_counter, const int &_display, const char *_text) {
  ...
  table.set_function("displayTwoCountersWithStringLocal",
                     [](const int &_leftCounter, const int &_rightCounter, const char *_text) {
  ...
  table.set_function("setCounterFlashWhenFirstDisplayedLocal",
                     [](const int &_counter, const bool &_state) { Command<0x0E56>(_counter, _state); });
