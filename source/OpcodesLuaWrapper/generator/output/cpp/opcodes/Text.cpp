...
void bindText(sol::state &state) {
  ...
  // default
  table.set_function(
      "printBig", [](const int &_key, const int &_time, const int &_style) { Command<0x00BA>(_key, _time, _style); });
  table.set_function("print",
                     [](const int &_key, const int &_time, const int &_flag) { Command<0x00BB>(_key, _time, _flag); });
  table.set_function("printNow",
                     [](const int &_key, const int &_time, const int &_flag) { Command<0x00BC>(_key, _time, _flag); });
  table.set_function("clearPrints", []() { Command<0x00BE>(); });
  table.set_function("printWithNumberBig", [](const int &_key, const int &_num, const int &_duration,
                                              const int &_style) { Command<0x01E3>(_key, _num, _duration, _style); });
  table.set_function("printWithNumber", [](const int &_key, const int &_num, const int &_duration, const int &_flag) {
    Command<0x01E4>(_key, _num, _duration, _flag);
  });
  table.set_function("printWithNumberNow", [](const int &_key, const int &_num, const int &_duration,
                                              const int &_flag) { Command<0x01E5>(_key, _num, _duration, _flag); });
  table.set_function("printBigQ", [](const int &_key, const int &_duration, const int &_style) {
    Command<0x0217>(_key, _duration, _style);
  });
  table.set_function("printWith2NumbersNow",
                     [](const int &_key, const int &_num1, const int &_num2, const int &_duration, const int &_style) {
                       Command<0x02FD>(_key, _num1, _num2, _duration, _style);
                     });
  table.set_function("printWith3Numbers",
                     [](const int &_key, const int &_num1, const int &_num2, const int &_num3, const int &_duration,
                        const int &_style) { Command<0x02FF>(_key, _num1, _num2, _num3, _duration, _style); });
  table.set_function("printWith4Numbers", [](const int &_key, const int &_num1, const int &_num2, const int &_num3,
                                             const int &_num4, const int &_duration, const int &_style) {
    Command<0x0302>(_key, _num1, _num2, _num3, _num4, _duration, _style);
  });
  table.set_function("printWith4NumbersNow", [](const int &_key, const int &_num1, const int &_num2, const int &_num3,
                                                const int &_num4, const int &_duration, const int &_style) {
    Command<0x0303>(_key, _num1, _num2, _num3, _num4, _duration, _style);
  });
  table.set_function("printWith6Numbers",
                     [](const int &_key, const int &_num1, const int &_num2, const int &_num3, const int &_num4,
  ...
  table.set_function("display", [](const float &_offsetLeft, const float &_offsetTop, const int &_key) {
  ...
  table.set_function("setJustify", [](const int &_state) { Command<0x0341>(_state); });
  table.set_function("setCenter", [](const int &_state) { Command<0x0342>(_state); });
  ...
  table.set_function("setBackground", [](const int &_state) { Command<0x0345>(_state); });
  table.set_function("setProportional", [](const int &_state) { Command<0x0348>(_state); });
  ...
  table.set_function("printStringInStringNow",
                     [](const int &_templateKey, const int &_replacementKey, const int &_duration, const int &_style) {
                       Command<0x0384>(_templateKey, _replacementKey, _duration, _style);
                     });
  table.set_function("clearThisPrint", [](const int &_key) { Command<0x03D5>(_key); });
  table.set_function("clearThisBigPrint", [](const int &_key) { Command<0x03D6>(_key); });
  table.set_function("setDrawBeforeFade", [](const int &_state) { Command<0x03E0>(_state); });
  table.set_function("setRightJustify", [](const int &_state) { Command<0x03E4>(_state); });
  table.set_function("printHelp", [](const int &_key) { Command<0x03E5>(_key); });
  table.set_function("clearHelp", []() { Command<0x03E6>(); });
  table.set_function("clearSmallPrints", []() { Command<0x03EB>(); });
  table.set_function("useCommands", [](const int &_state) { Command<0x03F0>(_state); });
  table.set_function("displayWithNumber",
                     [](const float &_offsetLeft, const float &_offsetTop, const int &_key, const int &_num) {
                       Command<0x045A>(_offsetLeft, _offsetTop, _key, _num);
                     });
  table.set_function("displayWith2Numbers",
                     [](const float &_offsetLeft, const float &_offsetTop, const int &_key, const int &_num1,
                        const int &_num2) { Command<0x045B>(_offsetLeft, _offsetTop, _key, _num1, _num2); });
  table.set_function("printHelpForever", [](const int &_key) { Command<0x0512>(_key); });
  table.set_function("printHelpForeverWithNumber",
                     [](const int &_gxt, const int &_number) { Command<0x0513>(_gxt, _number); });
  ...
  table.set_function("displayWithFloat",
                     [](const float &_leftTopX, const float &_leftTopY, const int &_key, const float &_value,
  ...
  table.set_function("setMessageFormatting", [](const int &__p1, const int &_margin, const int &_width) {
  ...
  table.set_function("addNextMessageToPreviousBriefs", [](const int &_state) { Command<0x09C1>(_state); });
  table.set_function("getStringWidth", [](const int &_entry) {
    int width_;
    Command<0x09FD>(_entry, &width_);
    return std::make_tuple(width_);
  });
  table.set_function("getStringWidthWithNumber", [](const int &_gxtEntry, const int &_number) {
    int width_;
  ...
  table.set_function("isThisHelpMessageBeingDisplayed", [](const int &_gxt) {
    auto result = Command<0x0A2A>(_gxt);
    return std::make_tuple(result);
  });
  table.set_function("drawSubtitlesBeforeFade", [](const int &_state) { Command<0x0A2C>(_state); });
  table.set_function("drawOddjobTitleBeforeFade", [](const int &_state) { Command<0x0A2D>(_state); });
  table.set_function("displayNonMinigameHelpMessages", [](const int &_state) { Command<0x0A44>(_state); });
  ...
  table.set_function("getLabelString", [](const int &_key) {
    const char *text_;
    Command<0x0ADE>(_key, (int *)&text_);
    return std::make_tuple(text_);
  });
  table.set_function("addLabel",
                     [](const int &_dynamicKey, const char *_text) { Command<0x0ADF>(_dynamicKey, _text); });
  table.set_function("removeLabel", [](const int &_key) { Command<0x0AE0>(_key); });
  ...
  table.set_function("drawString",
                     [](const char *_string, const int &_drawEvent, const float &_posX, const float &_posY,
                        const float &_sizeX, const float &_sizeY, const int &_fixAr, const int &_font) {
                       Command<0x0E62>(_string, _drawEvent, _posX, _posY, _sizeX, _sizeY, _fixAr, _font);
                     });
  table.set_function("drawStringExt",
                     [](const char *_string, const int &_drawEvent, const float &_posX, const float &_posY,
                        const float &_sizeX, const float &_sizeY, const int &_fixAr, const int &_font, const int &_prop,
                        const int &_align, const float &_wrap, const int &_justify, const int &_red, const int &_green,
                        const int &_blue, const int &_alpha, const int &_edge, const int &_shadow, const int &_dropRed,
                        const int &_dropGreen, const int &_dropBlue, const int &_dropAlpha, const int &_background,
                        const int &_backRed, const int &_backGreen, const int &_backBlue, const int &_backAlpha) {
                       Command<0x0E63>(_string, _drawEvent, _posX, _posY, _sizeX, _sizeY, _fixAr, _font, _prop, _align,
                                       _wrap, _justify, _red, _green, _blue, _alpha, _edge, _shadow, _dropRed,
                                       _dropGreen, _dropBlue, _dropAlpha, _background, _backRed, _backGreen, _backBlue,
                                       _backAlpha);
                     });
  table.set_function("isStringEqual", [](const char *_string1, const char *_string2, const int &_maxSize,
                                         const int &_caseSensitive, const char *_ignoreCharacter) {
