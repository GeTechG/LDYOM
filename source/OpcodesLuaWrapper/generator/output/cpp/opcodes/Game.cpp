...
void bindGame(sol::state &state) {
  ...
  table.set_function("setPoliceIgnorePlayer",
                     [](const int &_player, const bool &_state) { Command<0x01F7>(_player, _state); });
  table.set_function("setCollectableTotal", [](const int &_amount) { Command<0x02ED>(_amount); });
  table.set_function("setFreeResprays", [](const bool &_state) { Command<0x0335>(_state); });
  table.set_function("setEveryoneIgnorePlayer",
                     [](const int &_player, const bool &_state) { Command<0x03BF>(_player, _state); });
  ...
  table.set_function("setAllCarsCanBeDamaged", [](const bool &_state) { Command<0x03F4>(_state); });
  ...
  table.set_function("setAllTaxisHaveNitro", [](const bool &_state) { Command<0x0572>(_state); });
  table.set_function("setIsInStadium", [](const bool &_state) { Command<0x057E>(_state); });
  table.set_function("isAustralian", []() {
    auto result = Command<0x059A>();
    return std::make_tuple(result);
  });
  table.set_function("setLaRiots", [](const bool &_state) { Command<0x06C8>(_state); });
  table.set_function("switchEmergencyServices", [](const bool &_state) { Command<0x06D0>(_state); });
  table.set_function("switchRandomTrains", [](const bool &_state) { Command<0x06D7>(_state); });
  ...
  table.set_function("setPlayerPlayerTargeting", [](const bool &_state) { Command<0x06F3>(_state); });
  table.set_function("setPlayersCanBeInSeparateCars", [](const bool &_state) { Command<0x06FA>(_state); });
  table.set_function("switchCopsOnBikes", [](const bool &_state) { Command<0x072C>(_state); });
  ...
  table.set_function("setArea51SamSite", [](const bool &_state) { Command<0x07A8>(_state); });
  ...
  table.set_function("activateInteriorPeds", [](const bool &_state) { Command<0x084D>(_state); });
  table.set_function("enableEntryExitPlayerGroupWarping",
                     [](const float &_x, const float &_y, const float &_radius, const bool &_state) {
  ...
  table.set_function("setGangWarsActive", [](const bool &_state) { Command<0x0879>(_state); });
  table.set_function("isGangWarGoingOn", []() {
    auto result = Command<0x087A>();
    return std::make_tuple(result);
  });
  table.set_function("canTriggerGangWarWhenOnAMission", [](const bool &_state) { Command<0x08A3>(_state); });
  table.set_function("setAlwaysDraw3DMarkers", [](const bool &_state) { Command<0x08A8>(_state); });
  table.set_function("setGangWarsTrainingMission", [](const bool &_state) { Command<0x08AC>(_state); });
  table.set_function("setNightVision", [](const bool &_state) { Command<0x08B1>(_state); });
  table.set_function("setInfraredVision", [](const bool &_state) { Command<0x08B2>(_state); });
  table.set_function("switchDeathPenalties", [](const bool &_state) { Command<0x08DD>(_state); });
  table.set_function("switchArrestPenalties", [](const bool &_state) { Command<0x08DE>(_state); });
  table.set_function("setCreateRandomGangMembers", [](const bool &_state) { Command<0x08EA>(_state); });
  ...
  table.set_function("switchAmbientPlanes", [](const bool &_state) { Command<0x0923>(_state); });
  table.set_function("findMaxNumberOfGroupMembers", []() {
    int maxNum_;
    Command<0x0956>(&maxNum_);
    return std::make_tuple(maxNum_);
  });
  table.set_function("switchPoliceHelis", [](const bool &_state) { Command<0x096A>(_state); });
  table.set_function("forceDeathRestart", []() { Command<0x0970>(); });
  table.set_function("resetStuffUponResurrection", []() { Command<0x0974>(); });
  table.set_function("setOnlyCreateGangMembers", [](const bool &_state) { Command<0x0983>(_state); });
  table.set_function("setGunshotSenseRangeForRiot2", [](const float &_range) { Command<0x098A>(_range); });
  table.set_function("setNamedEntryExitFlag", [](const char *_name, const int &_entryexitsFlag, const bool &_state) {
  ...
  table.set_function("setCreateRandomCops", [](const bool &_state) { Command<0x099E>(_state); });
  table.set_function("showBlipsOnAllLevels", [](const bool &_state) { Command<0x09A6>(_state); });
  table.set_function("hideAllFrontendBlips", [](const bool &_state) { Command<0x09AC>(_state); });
  table.set_function("setMinigameInProgress", [](const bool &_state) { Command<0x09BD>(_state); });
  ...
  table.set_function("enableAmbientCrime", [](const bool &_state) { Command<0x09D2>(_state); });
  ...
  table.set_function("setAircraftCarrierSamSite", [](const bool &_state) { Command<0x09E4>(_state); });
  table.set_function("enableBurglaryHouses", [](const bool &_state) { Command<0x09E6>(_state); });
  table.set_function("shutAllCharsUp", [](const bool &_state) { Command<0x09F5>(_state); });
  ...
  table.set_function("setNoResprays", [](const bool &_state) { Command<0x0A14>(_state); });
  table.set_function("isWidescreenOnInOptions", []() {
    auto result = Command<0x0A2B>();
    return std::make_tuple(result);
  });
  table.set_function("forceAllVehicleLightsOff", [](const bool &_state) { Command<0x0A37>(_state); });
  table.set_function("activatePimpCheat", [](const bool &_state) { Command<0x0A3D>(_state); });
  table.set_function("setScriptCoopGame", [](const bool &_state) { Command<0x0A3F>(_state); });
  table.set_function("getRidOfPlayerProstitute", []() { Command<0x0A43>(); });
  table.set_function("switchObjectBrains",
                     [](const int &_type, const bool &_state) { Command<0x0A46>(_type, _state); });
  table.set_function("allowPauseInWidescreen", [](const bool &_state) { Command<0x0A48>(_state); });
  ...
  table.set_function("disableSecondPlayer", [](const bool &_restoreCamera) { Command<0x0EA1>(_restoreCamera); });
  table.set_function("fixTwoPlayersSeparatedCars", []() { Command<0x0EA2>(); });
  table.set_function("setOnMission", [](const bool &_status) { Command<0x0F16>(_status); });
