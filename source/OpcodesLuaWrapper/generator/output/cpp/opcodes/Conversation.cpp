...
void bindConversation(sol::state &state) {
  ...
  table.set_function("isAtNode", [](const int &_handle, const char *_speech) {
  ...
  table.set_function("enable", [](const int &_handle, const bool &_state) { Command<0x089C>(_handle, _state); });
  table.set_function("clearForChar", [](const int &_handle) { Command<0x08ED>(_handle); });
  table.set_function("setUpNodeWithSpeech", [](const char *_question, const char *_positiveAnswer,
                                               const char *_negativeAnswer, const int &_questionSoundId,
  ...
  table.set_function("setUpEndNodeWithSpeech",
                     [](const char *_speech, const int &_speechSoundId) { Command<0x09AA>(_speech, _speechSoundId); });
  table.set_function("setUpNodeWithScriptedSpeech",
                     [](const char *_question, const char *_positiveAnswer, const char *_negativeAnswer,
  ...
  table.set_function("setUpEndNodeWithScriptedSpeech",
                     [](const char *_speech, const int &_speechSoundId) { Command<0x0A3C>(_speech, _speechSoundId); });
