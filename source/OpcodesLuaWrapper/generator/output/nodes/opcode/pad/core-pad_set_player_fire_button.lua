...
---@class LDNodeEditorPadSetPlayerFireButtonNode : LDNodeEditorNode
---@field playerId integer
---@field state boolean

local PAD_SET_PLAYER_FIRE_BUTTON_NODE_TYPE = "core.pad_set_player_fire_button"

---@type LDNodeEditorNodeType
local padSetPlayerFireButtonNode = {
    typeName = PAD_SET_PLAYER_FIRE_BUTTON_NODE_TYPE,
    category = "opcode.pad",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorPadSetPlayerFireButtonNode
        local newNode = {
            id = newNodeId,
            nodeType = PAD_SET_PLAYER_FIRE_BUTTON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorPadSetPlayerFireButtonNode
    ...
    run = function(editor, node, inputValues)
		...
		PadOp.setPlayerFireButton(playerId, state)
        return {1}
    end
}

return padSetPlayerFireButtonNode
