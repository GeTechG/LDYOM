...
---@class LDNodeEditorCameraAttachToCharLookAtCharNode : LDNodeEditorNode
...
local CAMERA_ATTACH_TO_CHAR_LOOK_AT_CHAR_NODE_TYPE = "core.camera_attach_to_char_look_at_char"

---@type LDNodeEditorNodeType
local cameraAttachToCharLookAtCharNode = {
    typeName = CAMERA_ATTACH_TO_CHAR_LOOK_AT_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCameraAttachToCharLookAtCharNode
        local newNode = {
            id = newNodeId,
            nodeType = CAMERA_ATTACH_TO_CHAR_LOOK_AT_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCameraAttachToCharLookAtCharNode
...
return cameraAttachToCharLookAtCharNode
