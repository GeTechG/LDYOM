...
---@class LDNodeEditorCameraDoBumpNode : LDNodeEditorNode
---@field xOffset number
---@field yOffset number

local CAMERA_DO_BUMP_NODE_TYPE = "core.camera_do_bump"

---@type LDNodeEditorNodeType
local cameraDoBumpNode = {
    typeName = CAMERA_DO_BUMP_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCameraDoBumpNode
        local newNode = {
            id = newNodeId,
            nodeType = CAMERA_DO_BUMP_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
