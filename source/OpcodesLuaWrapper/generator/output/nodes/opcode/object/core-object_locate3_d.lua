...
---@class LDNodeEditorObjectLocate3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local OBJECT_LOCATE3_D_NODE_TYPE = "core.object_locate3_d"

---@type LDNodeEditorNodeType
local objectLocate3DNode = {
    typeName = OBJECT_LOCATE3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectLocate3DNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_LOCATE3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectLocate3DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = ObjectOp.locate3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return objectLocate3DNode
