...
---@class LDNodeEditorTextPrintBigStringNode : LDNodeEditorNode
---@field text string
---@field time integer
---@field style integer

local TEXT_PRINT_BIG_STRING_NODE_TYPE = "core.text_print_big_string"

---@type LDNodeEditorNodeType
local textPrintBigStringNode = {
    typeName = TEXT_PRINT_BIG_STRING_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintBigStringNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_BIG_STRING_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTextPrintBigStringNode
