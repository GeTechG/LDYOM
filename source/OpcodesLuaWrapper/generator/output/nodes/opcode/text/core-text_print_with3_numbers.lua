...
---@class LDNodeEditorTextPrintWith3NumbersNode : LDNodeEditorNode
---@field key string
---@field num1 integer
---@field num2 integer
---@field num3 integer
...
local TEXT_PRINT_WITH3_NUMBERS_NODE_TYPE = "core.text_print_with3_numbers"

---@type LDNodeEditorNodeType
local textPrintWith3NumbersNode = {
    typeName = TEXT_PRINT_WITH3_NUMBERS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintWith3NumbersNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_WITH3_NUMBERS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    draw = function(editor, ctx, node, builder)
		...
		LDNodeEditor.defaultInput(editor, ctx, builder, node.inputs[6], "duration", function ()
            node.duration = editor.dataTypes[node.inputs[6].type].drawEditValue(node.duration, "##durationEdit", fontScale * 100)
        end);

		LDNodeEditor.defaultInput(editor, ctx, builder, node.inputs[7], "style", function ()
            local name = "<Not set>";
...
return textPrintWith3NumbersNode
