...
---@class LDNodeEditorTextSetCenterSizeNode : LDNodeEditorNode
---@field width number

local TEXT_SET_CENTER_SIZE_NODE_TYPE = "core.text_set_center_size"

---@type LDNodeEditorNodeType
local textSetCenterSizeNode = {
    typeName = TEXT_SET_CENTER_SIZE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextSetCenterSizeNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_SET_CENTER_SIZE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
