...
---@class LDNodeEditorCarGetOffsetInWorldCoordsNode : LDNodeEditorNode
---@field self_ integer
---@field xOffset number
---@field yOffset number
---@field zOffset number

local CAR_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE = "core.car_get_offset_in_world_coords"

---@type LDNodeEditorNodeType
local carGetOffsetInWorldCoordsNode = {
    typeName = CAR_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarGetOffsetInWorldCoordsNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    run = function(editor, node, inputValues)
		...
		local x, y, z = CarOp.getOffsetInWorldCoords(self_, xOffset, yOffset, zOffset)
        return {1, x, y, z}
    end
}

return carGetOffsetInWorldCoordsNode
