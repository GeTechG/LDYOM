...
---@class LDNodeEditorCarIsInArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local CAR_IS_IN_AREA3_D_NODE_TYPE = "core.car_is_in_area3_d"

---@type LDNodeEditorNodeType
local carIsInArea3DNode = {
    typeName = CAR_IS_IN_AREA3_D_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarIsInArea3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_IS_IN_AREA3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarIsInArea3DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CarOp.isInArea3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {1, result}
    end
}

return carIsInArea3DNode
