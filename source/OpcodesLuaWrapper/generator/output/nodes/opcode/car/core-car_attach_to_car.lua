...
---@class LDNodeEditorCarAttachToCarNode : LDNodeEditorNode
---@field self_ integer
...
local CAR_ATTACH_TO_CAR_NODE_TYPE = "core.car_attach_to_car"

---@type LDNodeEditorNodeType
local carAttachToCarNode = {
    typeName = CAR_ATTACH_TO_CAR_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarAttachToCarNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_ATTACH_TO_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarAttachToCarNode
    ...
    run = function(editor, node, inputValues)
		...
		CarOp.attachToCar(self_, handle, xOffset, yOffset, zOffset, xRotation, yRotation, zRotation)
        return {1}
    end
}

return carAttachToCarNode
