...
---@class LDNodeEditorCarOpenDoorNode : LDNodeEditorNode
---@field self_ integer
---@field door integer

local CAR_OPEN_DOOR_NODE_TYPE = "core.car_open_door"

---@type LDNodeEditorNodeType
local carOpenDoorNode = {
    typeName = CAR_OPEN_DOOR_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarOpenDoorNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_OPEN_DOOR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarOpenDoorNode
    ...
    run = function(editor, node, inputValues)
		...
		CarOp.openDoor(self_, door)
        return {1}
    end
}

return carOpenDoorNode
