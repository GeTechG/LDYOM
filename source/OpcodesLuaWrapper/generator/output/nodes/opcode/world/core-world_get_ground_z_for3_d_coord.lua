...
---@class LDNodeEditorWorldGetGroundZFor3DCoordNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number

local WORLD_GET_GROUND_Z_FOR3_D_COORD_NODE_TYPE = "core.world_get_ground_z_for3_d_coord"

---@type LDNodeEditorNodeType
local worldGetGroundZFor3DCoordNode = {
    typeName = WORLD_GET_GROUND_Z_FOR3_D_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldGetGroundZFor3DCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_GET_GROUND_Z_FOR3_D_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWorldGetGroundZFor3DCoordNode
    ...
    draw = function(editor, ctx, node, builder)
		...
		LDNodeEditor.defaultOutput(editor, ctx, builder, node.outputs[2], "groundZ");
    ...
    run = function(editor, node, inputValues)
		...
		local groundZ = WorldOp.getGroundZFor3DCoord(x, y, z)
        return {1, groundZ}
    end
}

return worldGetGroundZFor3DCoordNode
