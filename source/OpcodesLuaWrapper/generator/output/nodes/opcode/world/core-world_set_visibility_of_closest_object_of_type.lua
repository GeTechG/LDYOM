...
---@class LDNodeEditorWorldSetVisibilityOfClosestObjectOfTypeNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field radius number
...
local WORLD_SET_VISIBILITY_OF_CLOSEST_OBJECT_OF_TYPE_NODE_TYPE = "core.world_set_visibility_of_closest_object_of_type"

---@type LDNodeEditorNodeType
local worldSetVisibilityOfClosestObjectOfTypeNode = {
    typeName = WORLD_SET_VISIBILITY_OF_CLOSEST_OBJECT_OF_TYPE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldSetVisibilityOfClosestObjectOfTypeNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_SET_VISIBILITY_OF_CLOSEST_OBJECT_OF_TYPE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWorldSetVisibilityOfClosestObjectOfTypeNode
    ...
    run = function(editor, node, inputValues)
		...
		WorldOp.setVisibilityOfClosestObjectOfType(x, y, z, radius, modelId, state)
        return {1}
    end
}

return worldSetVisibilityOfClosestObjectOfTypeNode
