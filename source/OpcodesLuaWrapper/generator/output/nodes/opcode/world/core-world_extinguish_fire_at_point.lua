...
---@class LDNodeEditorWorldExtinguishFireAtPointNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field radius number

local WORLD_EXTINGUISH_FIRE_AT_POINT_NODE_TYPE = "core.world_extinguish_fire_at_point"

---@type LDNodeEditorNodeType
local worldExtinguishFireAtPointNode = {
    typeName = WORLD_EXTINGUISH_FIRE_AT_POINT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldExtinguishFireAtPointNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_EXTINGUISH_FIRE_AT_POINT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWorldExtinguishFireAtPointNode
    ...
    run = function(editor, node, inputValues)
		...
		WorldOp.extinguishFireAtPoint(x, y, z, radius)
        return {1}
    end
}

return worldExtinguishFireAtPointNode
