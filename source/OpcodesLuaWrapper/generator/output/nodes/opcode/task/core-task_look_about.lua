...
---@class LDNodeEditorTaskLookAboutNode : LDNodeEditorNode
---@field handle integer
---@field time integer

local TASK_LOOK_ABOUT_NODE_TYPE = "core.task_look_about"

---@type LDNodeEditorNodeType
local taskLookAboutNode = {
    typeName = TASK_LOOK_ABOUT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskLookAboutNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_LOOK_ABOUT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskLookAboutNode
