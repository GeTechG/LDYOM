...
---@class LDNodeEditorTaskShootAtCharNode : LDNodeEditorNode
---@field handle integer
---@field target integer
---@field time integer

local TASK_SHOOT_AT_CHAR_NODE_TYPE = "core.task_shoot_at_char"

---@type LDNodeEditorNodeType
local taskShootAtCharNode = {
    typeName = TASK_SHOOT_AT_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskShootAtCharNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SHOOT_AT_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskShootAtCharNode
