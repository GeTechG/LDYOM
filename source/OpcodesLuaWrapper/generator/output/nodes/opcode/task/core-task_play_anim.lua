...
---@class LDNodeEditorTaskPlayAnimNode : LDNodeEditorNode
...
local TASK_PLAY_ANIM_NODE_TYPE = "core.task_play_anim"

---@type LDNodeEditorNodeType
local taskPlayAnimNode = {
    typeName = TASK_PLAY_ANIM_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskPlayAnimNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_PLAY_ANIM_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskPlayAnimNode
