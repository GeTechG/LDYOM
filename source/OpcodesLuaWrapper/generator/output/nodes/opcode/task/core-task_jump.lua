...
---@class LDNodeEditorTaskJumpNode : LDNodeEditorNode
---@field handle integer
---@field state boolean

local TASK_JUMP_NODE_TYPE = "core.task_jump"

---@type LDNodeEditorNodeType
local taskJumpNode = {
    typeName = TASK_JUMP_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskJumpNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_JUMP_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskJumpNode
