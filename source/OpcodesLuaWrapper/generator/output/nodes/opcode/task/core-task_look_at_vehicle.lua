...
---@class LDNodeEditorTaskLookAtVehicleNode : LDNodeEditorNode
---@field char integer
---@field vehicle integer
---@field time integer

local TASK_LOOK_AT_VEHICLE_NODE_TYPE = "core.task_look_at_vehicle"

---@type LDNodeEditorNodeType
local taskLookAtVehicleNode = {
    typeName = TASK_LOOK_AT_VEHICLE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskLookAtVehicleNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_LOOK_AT_VEHICLE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskLookAtVehicleNode
