...
---@class LDNodeEditorCharSetRotationNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHAR_SET_ROTATION_NODE_TYPE = "core.char_set_rotation"

---@type LDNodeEditorNodeType
local charSetRotationNode = {
    typeName = CHAR_SET_ROTATION_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetRotationNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_ROTATION_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetRotationNode
    ...
    run = function(editor, node, inputValues)
		...
		CharOp.setRotation(self_, x, y, z)
        return {1}
    end
}

return charSetRotationNode
