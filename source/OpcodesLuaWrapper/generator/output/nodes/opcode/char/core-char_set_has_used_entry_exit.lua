...
---@class LDNodeEditorCharSetHasUsedEntryExitNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field radius number

local CHAR_SET_HAS_USED_ENTRY_EXIT_NODE_TYPE = "core.char_set_has_used_entry_exit"

---@type LDNodeEditorNodeType
local charSetHasUsedEntryExitNode = {
    typeName = CHAR_SET_HAS_USED_ENTRY_EXIT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetHasUsedEntryExitNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_HAS_USED_ENTRY_EXIT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetHasUsedEntryExitNode
    ...
    run = function(editor, node, inputValues)
		...
		CharOp.setHasUsedEntryExit(self_, x, y, radius)
        return {1}
    end
}

return charSetHasUsedEntryExitNode
