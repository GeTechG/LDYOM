...
---@class LDNodeEditorCharIsHoldingObjectNode : LDNodeEditorNode
---@field self_ integer
---@field handle integer

local CHAR_IS_HOLDING_OBJECT_NODE_TYPE = "core.char_is_holding_object"

---@type LDNodeEditorNodeType
local charIsHoldingObjectNode = {
    typeName = CHAR_IS_HOLDING_OBJECT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsHoldingObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_HOLDING_OBJECT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return charIsHoldingObjectNode
