...
---@class LDNodeEditorCharLocateStoppedOnFoot2DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
...
local CHAR_LOCATE_STOPPED_ON_FOOT2_D_NODE_TYPE = "core.char_locate_stopped_on_foot2_d"

---@type LDNodeEditorNodeType
local charLocateStoppedOnFoot2DNode = {
    typeName = CHAR_LOCATE_STOPPED_ON_FOOT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateStoppedOnFoot2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_STOPPED_ON_FOOT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateStoppedOnFoot2DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.locateStoppedOnFoot2D(self_, x, y, xRadius, yRadius, drawSphere)
        return {1, result}
    end
}

return charLocateStoppedOnFoot2DNode
