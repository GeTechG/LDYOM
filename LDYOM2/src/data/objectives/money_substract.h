...
namespace objectives::money_subtract {
constexpr const char* TYPE = "core.money_subtract";
...
struct Data {
	...
	static void sol_lua_register(sol::state_view lua_state) {
		auto ut = lua_state.new_usertype<Data>("ObjectiveMoneySubtractData");
...
ktwait execute(Data& data) {
	...
	CWorld::Players[0].m_nMoney -= data.money;
