# Entity Orientation Specification

## Purpose

Single-source-of-truth orientation model for entities (actors, vehicles) driven by the entity rotation quaternion and edited via the transform gizmo.
