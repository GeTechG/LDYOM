local fa = {
    ...
    ICON_FA_ALIEN_MONSTER = "\xef\xa3\xb6",
    ...
    ICON_FA_APPLE_CRATE = "\xef\x9a\xb1",
    ...
    ICON_FA_ARROW_ALT_DOWN = "\xef\x8d\x94",
    ICON_FA_ARROW_ALT_FROM_BOTTOM = "\xef\x8d\x86",
    ICON_FA_ARROW_ALT_FROM_LEFT = "\xef\x8d\x87",
    ICON_FA_ARROW_ALT_FROM_RIGHT = "\xef\x8d\x88",
    ICON_FA_ARROW_ALT_FROM_TOP = "\xef\x8d\x89",
    ICON_FA_ARROW_ALT_LEFT = "\xef\x8d\x95",
    ICON_FA_ARROW_ALT_RIGHT = "\xef\x8d\x96",
    ICON_FA_ARROW_ALT_SQUARE_DOWN = "\xef\x8d\x90",
    ICON_FA_ARROW_ALT_SQUARE_LEFT = "\xef\x8d\x91",
    ICON_FA_ARROW_ALT_SQUARE_RIGHT = "\xef\x8d\x92",
    ICON_FA_ARROW_ALT_SQUARE_UP = "\xef\x8d\x93",
    ICON_FA_ARROW_ALT_TO_BOTTOM = "\xef\x8d\x8a",
    ICON_FA_ARROW_ALT_TO_LEFT = "\xef\x8d\x8b",
    ICON_FA_ARROW_ALT_TO_RIGHT = "\xef\x8d\x8c",
    ICON_FA_ARROW_ALT_TO_TOP = "\xef\x8d\x8d",
    ICON_FA_ARROW_ALT_UP = "\xef\x8d\x97",
    ...
    ICON_FA_ARROW_FROM_BOTTOM = "\xef\x8d\x82",
    ICON_FA_ARROW_FROM_LEFT = "\xef\x8d\x83",
    ICON_FA_ARROW_FROM_RIGHT = "\xef\x8d\x84",
    ICON_FA_ARROW_FROM_TOP = "\xef\x8d\x85",
    ICON_FA_ARROW_LEFT = "\xef\x81\xa0",
    ICON_FA_ARROW_RIGHT = "\xef\x81\xa1",
    ICON_FA_ARROW_SQUARE_DOWN = "\xef\x8c\xb9",
    ICON_FA_ARROW_SQUARE_LEFT = "\xef\x8c\xba",
    ICON_FA_ARROW_SQUARE_RIGHT = "\xef\x8c\xbb",
    ICON_FA_ARROW_SQUARE_UP = "\xef\x8c\xbc",
    ICON_FA_ARROW_TO_BOTTOM = "\xef\x8c\xbd",
    ICON_FA_ARROW_TO_LEFT = "\xef\x8c\xbe",
    ICON_FA_ARROW_TO_RIGHT = "\xef\x8d\x80",
    ICON_FA_ARROW_TO_TOP = "\xef\x8d\x81",
    ...
    ICON_FA_BALANCE_SCALE_LEFT = "\xef\x94\x95",
    ICON_FA_BALANCE_SCALE_RIGHT = "\xef\x94\x96",
    ...
    ICON_FA_BETAMAX = "\xef\xa2\xa4",
    ICON_FA_BEZIER_CURVE = "\xef\x95\x9b",
    ICON_FA_BIBLE = "\xef\x99\x87",
    ICON_FA_BICYCLE = "\xef\x88\x86",
    ICON_FA_BIKING = "\xef\xa1\x8a",
    ICON_FA_BIKING_MOUNTAIN = "\xef\xa1\x8b",
    ...
    ICON_FA_BOOK_SPELLS = "\xef\x9a\xb8",
    ...
    ICON_FA_BORDER_STYLE = "\xef\xa1\x93",
    ICON_FA_BORDER_STYLE_ALT = "\xef\xa1\x94",
    ...
    ICON_FA_CALCULATOR_ALT = "\xef\x99\x8c",
    ...
    ICON_FA_CALENDAR_EDIT = "\xef\x8c\xb3",
    ...
    ICON_FA_CAMERA_ALT = "\xef\x8c\xb2",
    ICON_FA_CAMERA_HOME = "\xef\xa3\xbe",
    ...
    ICON_FA_CAR_MECHANIC = "\xef\x97\xa3",
    ICON_FA_CAR_SIDE = "\xef\x97\xa4",
    ICON_FA_CAR_TILT = "\xef\x97\xa5",
    ICON_FA_CAR_WASH = "\xef\x97\xa6",
    ICON_FA_CARAVAN = "\xef\xa3\xbf",
    ICON_FA_CARAVAN_ALT = "\xee\x80\x80",
    ICON_FA_CARET_CIRCLE_DOWN = "\xef\x8c\xad",
    ICON_FA_CARET_CIRCLE_LEFT = "\xef\x8c\xae",
    ICON_FA_CARET_CIRCLE_RIGHT = "\xef\x8c\xb0",
    ICON_FA_CARET_CIRCLE_UP = "\xef\x8c\xb1",
    ...
    ICON_FA_CHART_PIE_ALT = "\xef\x99\x8e",
    ...
    ICON_FA_CHEESEBURGER = "\xef\x9f\xb1",
    ICON_FA_CHESS = "\xef\x90\xb9",
    ICON_FA_CHESS_BISHOP = "\xef\x90\xba",
    ICON_FA_CHESS_BISHOP_ALT = "\xef\x90\xbb",
    ICON_FA_CHESS_BOARD = "\xef\x90\xbc",
    ICON_FA_CHESS_CLOCK = "\xef\x90\xbd",
    ICON_FA_CHESS_CLOCK_ALT = "\xef\x90\xbe",
    ICON_FA_CHESS_KING = "\xef\x90\xbf",
    ICON_FA_CHESS_KING_ALT = "\xef\x91\x80",
    ICON_FA_CHESS_KNIGHT = "\xef\x91\x81",
    ICON_FA_CHESS_KNIGHT_ALT = "\xef\x91\x82",
    ICON_FA_CHESS_PAWN = "\xef\x91\x83",
    ICON_FA_CHESS_PAWN_ALT = "\xef\x91\x84",
    ICON_FA_CHESS_QUEEN = "\xef\x91\x85",
    ICON_FA_CHESS_QUEEN_ALT = "\xef\x91\x86",
    ICON_FA_CHESS_ROOK = "\xef\x91\x87",
    ICON_FA_CHESS_ROOK_ALT = "\xef\x91\x88",
    ...
    ICON_FA_CHEVRON_DOUBLE_DOWN = "\xef\x8c\xa2",
    ICON_FA_CHEVRON_DOUBLE_LEFT = "\xef\x8c\xa3",
    ICON_FA_CHEVRON_DOUBLE_RIGHT = "\xef\x8c\xa4",
    ICON_FA_CHEVRON_DOUBLE_UP = "\xef\x8c\xa5",
    ICON_FA_CHEVRON_DOWN = "\xef\x81\xb8",
    ICON_FA_CHEVRON_LEFT = "\xef\x81\x93",
    ICON_FA_CHEVRON_RIGHT = "\xef\x81\x94",
    ICON_FA_CHEVRON_SQUARE_DOWN = "\xef\x8c\xa9",
    ICON_FA_CHEVRON_SQUARE_LEFT = "\xef\x8c\xaa",
    ICON_FA_CHEVRON_SQUARE_RIGHT = "\xef\x8c\xab",
    ICON_FA_CHEVRON_SQUARE_UP = "\xef\x8c\xac",
    ...
    ICON_FA_COFFEE_TOGO = "\xef\x9b\x85",
    ...
    ICON_FA_COMMENT_ALT_CHECK = "\xef\x92\xa2",
    ICON_FA_COMMENT_ALT_DOLLAR = "\xef\x99\x90",
    ICON_FA_COMMENT_ALT_DOTS = "\xef\x92\xa3",
    ICON_FA_COMMENT_ALT_EDIT = "\xef\x92\xa4",
    ICON_FA_COMMENT_ALT_EXCLAMATION = "\xef\x92\xa5",
    ICON_FA_COMMENT_ALT_LINES = "\xef\x92\xa6",
    ICON_FA_COMMENT_ALT_MEDICAL = "\xef\x9f\xb4",
    ICON_FA_COMMENT_ALT_MINUS = "\xef\x92\xa7",
    ICON_FA_COMMENT_ALT_MUSIC = "\xef\xa2\xaf",
    ICON_FA_COMMENT_ALT_PLUS = "\xef\x92\xa8",
    ICON_FA_COMMENT_ALT_SLASH = "\xef\x92\xa9",
    ICON_FA_COMMENT_ALT_SMILE = "\xef\x92\xaa",
    ICON_FA_COMMENT_ALT_TIMES = "\xef\x92\xab",
    ICON_FA_COMMENT_CHECK = "\xef\x92\xac",
    ICON_FA_COMMENT_DOLLAR = "\xef\x99\x91",
    ICON_FA_COMMENT_DOTS = "\xef\x92\xad",
    ICON_FA_COMMENT_EDIT = "\xef\x92\xae",
    ...
    ICON_FA_COMMENT_TIMES = "\xef\x92\xb5",
    ICON_FA_COMMENTS = "\xef\x82\x86",
    ICON_FA_COMMENTS_ALT = "\xef\x92\xb6",
    ICON_FA_COMMENTS_ALT_DOLLAR = "\xef\x99\x92",
    ...
    ICON_FA_COMPRESS_ALT = "\xef\x90\xa2",
    ...
    ICON_FA_DOLLY_FLATBED_ALT = "\xef\x91\xb5",
    ICON_FA_DOLLY_FLATBED_EMPTY = "\xef\x91\xb6",
    ...
    ICON_FA_ECLIPSE_ALT = "\xef\x9d\x8a",
    ...
    ICON_FA_ELLIPSIS_H_ALT = "\xef\x8e\x9b",
    ICON_FA_ELLIPSIS_V = "\xef\x85\x82",
    ICON_FA_ELLIPSIS_V_ALT = "\xef\x8e\x9c",
    ...
    ICON_FA_EXCLAMATION_SQUARE = "\xef\x8c\xa1",
    ICON_FA_EXCLAMATION_TRIANGLE = "\xef\x81\xb1",
    ICON_FA_EXPAND = "\xef\x81\xa5",
    ICON_FA_EXPAND_ALT = "\xef\x90\xa4",
    ICON_FA_EXPAND_ARROWS = "\xef\x8c\x9d",
    ...
    ICON_FA_FIELD_HOCKEY = "\xef\x91\x8c",
    ...
    ICON_FA_FILE_CHART_LINE = "\xef\x99\x99",
    ...
    ICON_FA_FLAG_ALT = "\xef\x9d\x8c",
    ICON_FA_FLAG_CHECKERED = "\xef\x84\x9e",
    ICON_FA_FLAG_USA = "\xef\x9d\x8d",
    ICON_FA_FLAME = "\xef\x9b\x9f",
    ICON_FA_FLASHLIGHT = "\xef\xa2\xb8",
    ICON_FA_FLASK = "\xef\x83\x83",
    ICON_FA_FLASK_POISON = "\xef\x9b\xa0",
    ICON_FA_FLASK_POTION = "\xef\x9b\xa1",
    ...
    ICON_FA_FRAGILE = "\xef\x92\xbb",
    ICON_FA_FRENCH_FRIES = "\xef\xa0\x83",
    ICON_FA_FROG = "\xef\x94\xae",
    ICON_FA_FROSTY_HEAD = "\xef\x9e\x9b",
    ...
    ICON_FA_GLASS_CHAMPAGNE = "\xef\x9e\x9e",
    ...
    ICON_FA_GLASS_WHISKEY_ROCKS = "\xef\x9e\xa1",
    ICON_FA_GLASSES = "\xef\x94\xb0",
    ICON_FA_GLASSES_ALT = "\xef\x97\xb5",
    ...
    ICON_FA_HAND_HOLDING_WATER = "\xef\x93\x81",
    ...
    ICON_FA_HAND_RECEIVING = "\xef\x91\xbc",
    ...
    ICON_FA_HANDS_HEART = "\xef\x93\x83",
    ICON_FA_HANDS_HELPING = "\xef\x93\x84",
    ICON_FA_HANDS_USD = "\xef\x93\x85",
    ICON_FA_HANDS_WASH = "\xee\x81\x9e",
    ICON_FA_HANDSHAKE = "\xef\x8a\xb5",
    ICON_FA_HANDSHAKE_ALT = "\xef\x93\x86",
    ICON_FA_HANDSHAKE_ALT_SLASH = "\xee\x81\x9f",
    ...
    ICON_FA_HEART_CIRCLE = "\xef\x93\x87",
    ICON_FA_HEART_RATE = "\xef\x97\xb8",
    ICON_FA_HEART_SQUARE = "\xef\x93\x88",
    ...
    ICON_FA_HOME_ALT = "\xef\xa0\x8a",
    ICON_FA_HOME_HEART = "\xef\x93\x89",
    ICON_FA_HOME_LG = "\xef\xa0\x8b",
    ICON_FA_HOME_LG_ALT = "\xef\xa0\x8c",
    ...
    ICON_FA_LOCATION = "\xef\x98\x81",
    ICON_FA_LOCATION_ARROW = "\xef\x84\xa4",
    ICON_FA_LOCATION_CIRCLE = "\xef\x98\x82",
    ICON_FA_LOCATION_SLASH = "\xef\x98\x83",
    ICON_FA_LOCK = "\xef\x80\xa3",
    ICON_FA_LOCK_ALT = "\xef\x8c\x8d",
    ICON_FA_LOCK_OPEN = "\xef\x8f\x81",
    ICON_FA_LOCK_OPEN_ALT = "\xef\x8f\x82",
    ...
    ICON_FA_MAP_MARKER_ALT_SLASH = "\xef\x98\x85",
    ICON_FA_MAP_MARKER_CHECK = "\xef\x98\x86",
    ICON_FA_MAP_MARKER_EDIT = "\xef\x98\x87",
    ICON_FA_MAP_MARKER_EXCLAMATION = "\xef\x98\x88",
    ICON_FA_MAP_MARKER_MINUS = "\xef\x98\x89",
    ICON_FA_MAP_MARKER_PLUS = "\xef\x98\x8a",
    ICON_FA_MAP_MARKER_QUESTION = "\xef\x98\x8b",
    ICON_FA_MAP_MARKER_SLASH = "\xef\x98\x8c",
    ICON_FA_MAP_MARKER_SMILE = "\xef\x98\x8d",
    ICON_FA_MAP_MARKER_TIMES = "\xef\x98\x8e",
    ...
    ICON_FA_MIND_SHARE = "\xef\x99\xb7",
    ICON_FA_MINUS = "\xef\x81\xa8",
    ICON_FA_MINUS_CIRCLE = "\xef\x81\x96",
    ICON_FA_MINUS_HEXAGON = "\xef\x8c\x87",
    ICON_FA_MINUS_OCTAGON = "\xef\x8c\x88",
    ...
    ICON_FA_MOBILE_ANDROID = "\xef\x8f\x8e",
    ICON_FA_MOBILE_ANDROID_ALT = "\xef\x8f\x8f",
    ...
    ICON_FA_MONEY_CHECK_EDIT = "\xef\xa1\xb2",
    ICON_FA_MONEY_CHECK_EDIT_ALT = "\xef\xa1\xb3",
    ICON_FA_MONITOR_HEART_RATE = "\xef\x98\x91",
    ...
    ICON_FA_MOUSE = "\xef\xa3\x8c",
    ICON_FA_MOUSE_ALT = "\xef\xa3\x8d",
    ...
    ICON_FA_MUSIC_ALT = "\xef\xa3\x8f",
    ICON_FA_MUSIC_ALT_SLASH = "\xef\xa3\x90",
    ...
    ICON_FA_PARAGRAPH_RTL = "\xef\xa1\xb8",
    ICON_FA_PARKING = "\xef\x95\x80",
    ICON_FA_PARKING_CIRCLE = "\xef\x98\x95",
    ICON_FA_PARKING_CIRCLE_SLASH = "\xef\x98\x96",
    ICON_FA_PARKING_SLASH = "\xef\x98\x97",
    ...
    ICON_FA_PENCIL_PAINTBRUSH = "\xef\x98\x98",
    ICON_FA_PENCIL_RULER = "\xef\x96\xae",
    ICON_FA_PENNANT = "\xef\x91\x96",
    ...
    ICON_FA_PERSON_CARRY = "\xef\x93\x8f",
    ...
    ICON_FA_PHONE_ALT = "\xef\xa1\xb9",
    ICON_FA_PHONE_LAPTOP = "\xef\xa1\xba",
    ...
    ICON_FA_PHONE_SQUARE_ALT = "\xef\xa1\xbb",
    ICON_FA_PHONE_VOLUME = "\xef\x8a\xa0",
    ICON_FA_PHOTO_VIDEO = "\xef\xa1\xbc",
    ...
    ICON_FA_PLUS_HEXAGON = "\xef\x8c\x80",
    ICON_FA_PLUS_OCTAGON = "\xef\x8c\x81",
    ...
    ICON_FA_PORTAL_ENTER = "\xee\x80\xa2",
    ICON_FA_PORTAL_EXIT = "\xee\x80\xa3",
    ...
    ICON_FA_PRESENTATION = "\xef\x9a\x85",
    ICON_FA_PRINT = "\xef\x80\xaf",
    ICON_FA_PRINT_SEARCH = "\xef\xa0\x9a",
    ...
    ICON_FA_QUESTION_SQUARE = "\xef\x8b\xbd",
    ...
    ICON_FA_RABBIT_FAST = "\xef\x9c\x89",
    ...
    ICON_FA_RECTANGLE_LANDSCAPE = "\xef\x8b\xba",
    ICON_FA_RECTANGLE_PORTRAIT = "\xef\x8b\xbb",
    ...
    ICON_FA_REMOVE_FORMAT = "\xef\xa1\xbd",
    ICON_FA_REPEAT = "\xef\x8d\xa3",
    ICON_FA_REPEAT_1 = "\xef\x8d\xa5",
    ICON_FA_REPEAT_1_ALT = "\xef\x8d\xa6",
    ICON_FA_REPEAT_ALT = "\xef\x8d\xa4",
    ...
    ICON_FA_RETWEET_ALT = "\xef\x8d\xa1",
    ...
    ICON_FA_SAX_HOT = "\xef\xa3\x9b",
    ICON_FA_SAXOPHONE = "\xef\xa3\x9c",
    ICON_FA_SCALPEL = "\xef\x98\x9d",
    ICON_FA_SCALPEL_PATH = "\xef\x98\x9e",
    ICON_FA_SCANNER = "\xef\x92\x88",
    ...
    ICON_FA_SENSOR_ALERT = "\xee\x80\xa9",
    ICON_FA_SENSOR_FIRE = "\xee\x80\xaa",
    ICON_FA_SENSOR_ON = "\xee\x80\xab",
    ICON_FA_SENSOR_SMOKE = "\xee\x80\xac",
    ...
    ICON_FA_SHIPPING_TIMED = "\xef\x92\x8c",
    ...
    ICON_FA_SIGNAL_1 = "\xef\x9a\x8c",
    ICON_FA_SIGNAL_2 = "\xef\x9a\x8d",
    ICON_FA_SIGNAL_3 = "\xef\x9a\x8e",
    ICON_FA_SIGNAL_4 = "\xef\x9a\x8f",
    ICON_FA_SIGNAL_ALT = "\xef\x9a\x90",
    ICON_FA_SIGNAL_ALT_1 = "\xef\x9a\x91",
    ICON_FA_SIGNAL_ALT_2 = "\xef\x9a\x92",
    ICON_FA_SIGNAL_ALT_3 = "\xef\x9a\x93",
    ICON_FA_SIGNAL_ALT_SLASH = "\xef\x9a\x94",
    ...
    ICON_FA_SKI_JUMP = "\xef\x9f\x87",
    ICON_FA_SKI_LIFT = "\xef\x9f\x88",
    ...
    ICON_FA_SLEDDING = "\xef\x9f\x8b",
    ICON_FA_SLEIGH = "\xef\x9f\x8c",
    ICON_FA_SLIDERS_H = "\xef\x87\x9e",
    ICON_FA_SLIDERS_H_SQUARE = "\xef\x8f\xb0",
    ICON_FA_SLIDERS_V = "\xef\x8f\xb1",
    ICON_FA_SLIDERS_V_SQUARE = "\xef\x8f\xb2",
    ICON_FA_SMILE = "\xef\x84\x98",
    ICON_FA_SMILE_BEAM = "\xef\x96\xb8",
    ICON_FA_SMILE_PLUS = "\xef\x96\xb9",
    ...
    ICON_FA_SNOWMOBILE = "\xef\x9f\x91",
    ...
    ICON_FA_SORT_ALPHA_DOWN_ALT = "\xef\xa2\x81",
    ICON_FA_SORT_ALPHA_UP = "\xef\x85\x9e",
    ICON_FA_SORT_ALPHA_UP_ALT = "\xef\xa2\x82",
    ICON_FA_SORT_ALT = "\xef\xa2\x83",
    ICON_FA_SORT_AMOUNT_DOWN = "\xef\x85\xa0",
    ICON_FA_SORT_AMOUNT_DOWN_ALT = "\xef\xa2\x84",
    ICON_FA_SORT_AMOUNT_UP = "\xef\x85\xa1",
    ICON_FA_SORT_AMOUNT_UP_ALT = "\xef\xa2\x85",
    ICON_FA_SORT_CIRCLE = "\xee\x80\xb0",
    ICON_FA_SORT_CIRCLE_DOWN = "\xee\x80\xb1",
    ICON_FA_SORT_CIRCLE_UP = "\xee\x80\xb2",
    ICON_FA_SORT_DOWN = "\xef\x83\x9d",
    ICON_FA_SORT_NUMERIC_DOWN = "\xef\x85\xa2",
    ICON_FA_SORT_NUMERIC_DOWN_ALT = "\xef\xa2\x86",
    ICON_FA_SORT_NUMERIC_UP = "\xef\x85\xa3",
    ICON_FA_SORT_NUMERIC_UP_ALT = "\xef\xa2\x87",
    ICON_FA_SORT_SHAPES_DOWN = "\xef\xa2\x88",
    ICON_FA_SORT_SHAPES_DOWN_ALT = "\xef\xa2\x89",
    ICON_FA_SORT_SHAPES_UP = "\xef\xa2\x8a",
    ICON_FA_SORT_SHAPES_UP_ALT = "\xef\xa2\x8b",
    ICON_FA_SORT_SIZE_DOWN = "\xef\xa2\x8c",
    ICON_FA_SORT_SIZE_DOWN_ALT = "\xef\xa2\x8d",
    ICON_FA_SORT_SIZE_UP = "\xef\xa2\x8e",
    ICON_FA_SORT_SIZE_UP_ALT = "\xef\xa2\x8f",
    ICON_FA_SORT_UP = "\xef\x83\x9e",
    ICON_FA_SOUP = "\xef\xa0\xa3",
    ICON_FA_SPA = "\xef\x96\xbb",
    ICON_FA_SPACE_SHUTTLE = "\xef\x86\x97",
    ICON_FA_SPACE_STATION_MOON = "\xee\x80\xb3",
    ICON_FA_SPACE_STATION_MOON_ALT = "\xee\x80\xb4",
    ...
    ICON_FA_STARFIGHTER_ALT = "\xee\x80\xb8",
    ...
    ICON_FA_STORE_ALT_SLASH = "\xee\x81\xb0",
    ...
    ICON_FA_TABLET_ANDROID = "\xef\x8f\xbb",
    ICON_FA_TABLET_ANDROID_ALT = "\xef\x8f\xbc",
    ...
    ICON_FA_TACHOMETER_ALT_AVERAGE = "\xef\x98\xa4",
    ICON_FA_TACHOMETER_ALT_FAST = "\xef\x98\xa5",
    ICON_FA_TACHOMETER_ALT_FASTEST = "\xef\x98\xa6",
    ICON_FA_TACHOMETER_ALT_SLOW = "\xef\x98\xa7",
    ICON_FA_TACHOMETER_ALT_SLOWEST = "\xef\x98\xa8",
    ICON_FA_TACHOMETER_AVERAGE = "\xef\x98\xa9",
    ICON_FA_TACHOMETER_FAST = "\xef\x98\xaa",
    ICON_FA_TACHOMETER_FASTEST = "\xef\x98\xab",
    ICON_FA_TACHOMETER_SLOW = "\xef\x98\xac",
    ICON_FA_TACHOMETER_SLOWEST = "\xef\x98\xad",
    ICON_FA_TACO = "\xef\xa0\xa6",
    ICON_FA_TAG = "\xef\x80\xab",
    ICON_FA_TAGS = "\xef\x80\xac",
    ICON_FA_TALLY = "\xef\x9a\x9c",
    ICON_FA_TANAKH = "\xef\xa0\xa7",
    ICON_FA_TAPE = "\xef\x93\x9b",
    ICON_FA_TASKS = "\xef\x82\xae",
    ICON_FA_TASKS_ALT = "\xef\xa0\xa8",
    ICON_FA_TAXI = "\xef\x86\xba",
    ICON_FA_TEETH = "\xef\x98\xae",
    ICON_FA_TEETH_OPEN = "\xef\x98\xaf",
    ICON_FA_TELESCOPE = "\xee\x80\xbe",
    ICON_FA_TEMPERATURE_DOWN = "\xee\x80\xbf",
    ICON_FA_TEMPERATURE_FRIGID = "\xef\x9d\xa8",
    ICON_FA_TEMPERATURE_HIGH = "\xef\x9d\xa9",
    ICON_FA_TEMPERATURE_HOT = "\xef\x9d\xaa",
    ICON_FA_TEMPERATURE_LOW = "\xef\x9d\xab",
    ICON_FA_TEMPERATURE_UP = "\xee\x81\x80",
    ...
    ICON_FA_THUNDERSTORM = "\xef\x9d\xac",
    ICON_FA_THUNDERSTORM_MOON = "\xef\x9d\xad",
    ICON_FA_THUNDERSTORM_SUN = "\xef\x9d\xae",
    ICON_FA_TICKET = "\xef\x85\x85",
    ICON_FA_TICKET_ALT = "\xef\x8f\xbf",
    ICON_FA_TILDE = "\xef\x9a\x9f",
    ICON_FA_TIMES = "\xef\x80\x8d",
    ICON_FA_TIMES_CIRCLE = "\xef\x81\x97",
    ICON_FA_TIMES_HEXAGON = "\xef\x8b\xae",
    ICON_FA_TIMES_OCTAGON = "\xef\x8b\xb0",
    ICON_FA_TIMES_SQUARE = "\xef\x8b\x93",
    ...
    ICON_FA_TOILET_PAPER_ALT = "\xef\x9c\x9f",
    ICON_FA_TOILET_PAPER_SLASH = "\xee\x81\xb2",
    ICON_FA_TOMBSTONE = "\xef\x9c\xa0",
    ICON_FA_TOMBSTONE_ALT = "\xef\x9c\xa1",
    ...
    ICON_FA_TRASH_UNDO_ALT = "\xef\xa2\x96",
    ICON_FA_TREASURE_CHEST = "\xef\x9c\xa3",
    ICON_FA_TREE = "\xef\x86\xbb",
    ICON_FA_TREE_ALT = "\xef\x90\x80",
    ...
    ICON_FA_TRIANGLE_MUSIC = "\xef\xa3\xa2",
    ICON_FA_TROPHY = "\xef\x82\x91",
    ICON_FA_TROPHY_ALT = "\xef\x8b\xab",
    ICON_FA_TRUCK = "\xef\x83\x91",
    ICON_FA_TRUCK_CONTAINER = "\xef\x93\x9c",
    ICON_FA_TRUCK_COUCH = "\xef\x93\x9d",
    ...
    ICON_FA_USD_CIRCLE = "\xef\x8b\xa8",
    ICON_FA_USD_SQUARE = "\xef\x8b\xa9",
    ...
    ICON_FA_USER_CHART = "\xef\x9a\xa3",
    ...
    ICON_FA_USERS_CLASS = "\xef\x98\xbd",
    ICON_FA_USERS_COG = "\xef\x94\x89",
    ICON_FA_USERS_CROWN = "\xef\x9a\xa5",
    ICON_FA_USERS_MEDICAL = "\xef\xa0\xb0",
    ICON_FA_USERS_SLASH = "\xee\x81\xb3",
    ICON_FA_UTENSIL_FORK = "\xef\x8b\xa3",
    ICON_FA_UTENSIL_KNIFE = "\xef\x8b\xa4",
    ICON_FA_UTENSIL_SPOON = "\xef\x8b\xa5",
    ICON_FA_UTENSILS = "\xef\x8b\xa7",
    ICON_FA_UTENSILS_ALT = "\xef\x8b\xa6",
    ...
    ICON_FA_WAND_MAGIC = "\xef\x9c\xab",
    ICON_FA_WAREHOUSE = "\xef\x92\x94",
    ICON_FA_WAREHOUSE_ALT = "\xef\x92\x95",
    ICON_FA_WASHER = "\xef\xa2\x98",
    ICON_FA_WATCH = "\xef\x8b\xa1",
    ICON_FA_WATCH_CALCULATOR = "\xef\xa3\xb0",
    ICON_FA_WATCH_FITNESS = "\xef\x98\xbe",
    ICON_FA_WATER = "\xef\x9d\xb3",
    ICON_FA_WATER_LOWER = "\xef\x9d\xb4",
    ICON_FA_WATER_RISE = "\xef\x9d\xb5",
    ...
    ICON_FA_WAVEFORM_PATH = "\xef\xa3\xb2",
    ICON_FA_WEBCAM = "\xef\xa0\xb2",
    ICON_FA_WEBCAM_SLASH = "\xef\xa0\xb3",
    ...
    ICON_FA_WIFI_1 = "\xef\x9a\xaa",
    ICON_FA_WIFI_2 = "\xef\x9a\xab",
    ...
    ICON_FA_WINDOW_ALT = "\xef\x90\x8f",
