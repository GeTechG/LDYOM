...
KeywordsOp = {
	...
	---@param varId int
	---@param value any
    ["setCleoSharedVar"] = function(varId, value) end,
	---CLEO
    ---|  
	---@param varId int
	---@return any result
    ["getCleoSharedVar"] = function(varId) end,
	---CLEO
    ---| Ends the custom CLEO scripts with the specified name, freeing game memory 
	---@param scriptFileName string
    ["terminateAllCustomScriptsWithThisName"] = function(scriptFileName) end,
	---CLEO+
	...
	---CLEO+
    ---| Toggles script event just after some char is created 
	---@param add bool
	---@param label label
	---@param varChar Char
...
CameraOp = {
	...
	---@param tilt float
	---@param switchStyle SwitchType
    ["attachToVehicleLookAtChar"] = function(handle, xOffset, yOffset, zOffset, char, tilt, switchStyle) end,
	---default
...
PlayerOp = {
	...
	---@param self Player
	---@param state bool
    ["setIgnorePolice"] = function(self, state) end,
	---default
	...
	---@param self Player
	---@param handle Char
    ["isTargettingChar"] = function(self, handle) end,
	---default
    ---| Returns true if the player is aiming at the specified object 
	---@param self Player
	---@param handle Object
    ["isTargettingObject"] = function(self, handle) end,
	---default
	...
	---@param self Player
    ["isTargettingAnything"] = function(self) end,
	---default
    ---|  
	---@param self Player
	---@param state bool
...
CharOp = {
	...
	---@param self Char
	---@param modelId int
    ["getModel"] = function(self, modelId) end,
	---default
...
CarOp = {
	...
	---@param self Car
	---@param drivingStyle CarDrivingStyle
	...
	---@param self Car
	---@param path int
    ["startPlaybackRecorded"] = function(self, path) end,
	---default
    ---| Stops car from following path 
	---@param self Car
    ["stopPlaybackRecorded"] = function(self) end,
	---default
    ---| Freezes the car on its path 
	---@param self Car
    ["pausePlaybackRecorded"] = function(self) end,
	---default
    ---| Unfreezes the vehicle on its path 
	---@param self Car
    ["unpausePlaybackRecorded"] = function(self) end,
	---default
	...
	---@param y bool
	---@param z bool
    ["getSpeedVector"] = function(self, x, y, z) end,
	---default
    ---| Returns the vehicle's mass 
	---@param self Car
	---@param mass float
    ["getMass"] = function(self, mass) end,
	---default
    ...
    ---|  
	---@param self Car
    ["skipToEndAndStopPlaybackRecorded"] = function(self) end,
	---default
	...
	---@param self Car
	---@param pathId int
    ["startPlaybackRecordedUsingAi"] = function(self, pathId) end,
	---default
    ---| Advances the recorded car playback by the specified amount 
	---@param self Car
	---@param amount float
    ["skipInPlaybackRecorded"] = function(self, amount) end,
	---default
	...
	---@param self Car
	---@param pathId int
    ["startPlaybackRecordedLooped"] = function(self, pathId) end,
	---default
	...
	---@param self Car
	---@return int value
    ["getModelValue"] = function(self) end,
	---default
	...
	---@param weaponType WeaponType
	---@param intensity float
    ["getWeaponDamageLastFrame"] = function(self, char, weaponType, intensity) end,
}
TextOp = {
    ---default
	...
	---@param style TextStyle
	---@param args arguments
    ["printBigFormatted"] = function(text, time, style, args) end,
	---CLEO
    ---|  
	---@param text string
	---@param time int
	---@param arg arguments
    ["printFormatted"] = function(text, time, arg) end,
	---CLEO
    ---|  
	---@param text string
	---@param time int
	---@param arg arguments
    ["printFormattedNow"] = function(text, time, arg) end,
	---CLEO
    ---|  
	---@param format string
	---@param args arguments
	---@return string text
    ["stringFormat"] = function(format, args) end,
	---CLEO
    ---|  
	---@param str string
	---@param format string
	---@param args arguments
	---@return string text
    ["scanString"] = function(str, format, args) end,
	---CLEO
    ---|  
	---@param key gxt_key
	---@return string text
    ...
    ---|  
	---@param dynamicKey gxt_key
    ["removeLabel"] = function(dynamicKey) end,
	---CLEO
    ---|  
	---@param number float
	---@param format string
...
ObjectOp = {
	...
	---@param self Object
	---@param speed float
    ["getSpeed"] = function(self, speed) end,
	---default
	...
	---@param self Object
	---@param health int
    ["getHealth"] = function(self, health) end,
	---default
    ---|  
	---@param self Object
	---@param health int
	...
	---@param z float
	---@param w float
    ["getQuaternion"] = function(self, x, y, z, w) end,
	---default
	...
	---@param self Object
	---@param turnMass float
    ["getTurnMass"] = function(self, turnMass) end,
	---default
	...
	---@param self Object
	---@param model int
    ["getModel"] = function(self, model) end,
	---default
...
HudOp = {
	...
	---@param counter int
	---@param state bool
    ["setOnscreenCounterFlashWhenFirstDisplayed"] = function(counter, state) end,
	---default
	...
	---@param blue int
	---@param alpha int
    ["drawSpriteWithRotation"] = function(memorySlot, offsetLeft, offsetTop, height, width, angle, red, green, blue, alpha) end,
	---default
    ---|  
	---@param zoom int
...
WorldOp = {
	...
	---@param solid bool
	---@param target Char
    ["setCharUsesCollisionClosestObjectOfType"] = function(x, y, z, radius, modelId, solid, target) end,
	---default
	...
	---@param char Char
	---@return Car vehicle
    ["getRandomCarOfTypeInAngledAreaNoSave"] = function(leftBottomX, leftBottomY, rightTopX, rightTopY, angle, char) end,
	---default
...
GameOp = {
	...
	---@param handle Player
	---@param state bool
    ["setEveryoneIgnorePlayer"] = function(handle, state) end,
	---default
	...
	---@param toPedType PedType
	---@param relationshipType RelationshipType
    ["isRelationshipSet"] = function(ofPedType, toPedType, relationshipType) end,
	---default
...
PickupOp = {
	...
	---@param y float
	---@param z float
    ["getCoordinates"] = function(self, x, y, z) end,
	---default
    ---|  
	---@param self Pickup
	---@param value int
...
ScriptFireOp = {
	...
	---@param y float
	---@param z float
    ["getCoords"] = function(self, x, y, z) end,
	---default
...
StuckCarCheckOp = {
	...
	---@param speed float
	---@param duration int
    ["add"] = function(vehicle, speed, duration) end,
	---default
	...
	---@param warp bool
	---@param pathId int
    ["addWithWarp"] = function(vehicle, speed, duration, stuck, flipped, warp, pathId) end,
}
CreditsOp = {
    ---default
...
DebuggerOp = {
	...
	---@param msg string128
    ["saveStringToDebugFile"] = function(msg) end,
}
DecisionMakerCharOp = {
    ---default
...
OtherOp = {
    ---default
    ---| Synchronizes the water with the current time 
...
FileOp = {
	...
	---@param args arguments
	---@return string text
    ["scan"] = function(self, format, args) end,
}
DynamicLibraryOp = {
    ---CLEO
...
ColPointOp = {
	...
	---@return float y
	---@return float z
    ["getCoordinates"] = function(colPoint) end,
}
ClipboardOp = {
    ---clipboard
    ---|  
