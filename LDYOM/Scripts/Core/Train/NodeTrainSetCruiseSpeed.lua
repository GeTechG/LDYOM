...
Node = bitser.registerClass(class("NodeTrainSetCruiseSpeed", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeTrainSetCruiseSpeed");
...
function Node:draw()
	...
	imgui.Text(ldyom.langt("cruise_speed"));
