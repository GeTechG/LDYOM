...
Node = bitser.registerClass(class("NodeObjectIsOnScreen", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodeObjectIsOnScreen");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x02CC, {{object,"int"}});
end
