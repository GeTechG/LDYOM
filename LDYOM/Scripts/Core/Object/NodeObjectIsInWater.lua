...
Node = bitser.registerClass(class("NodeObjectIsInWater", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodeObjectIsInWater");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x04E7, {{object,"int"}});
end
