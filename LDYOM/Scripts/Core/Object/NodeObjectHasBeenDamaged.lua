...
Node = bitser.registerClass(class("NodeObjectHasBeenDamaged", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodeObjectHasBeenDamaged");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x0366, {{object,"int"}});
end
