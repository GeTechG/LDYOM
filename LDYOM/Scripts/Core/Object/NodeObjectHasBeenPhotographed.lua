...
Node = bitser.registerClass(class("NodeObjectHasBeenPhotographed", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodeObjectHasBeenPhotographed");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x0833, {{object,"int"}});
end
