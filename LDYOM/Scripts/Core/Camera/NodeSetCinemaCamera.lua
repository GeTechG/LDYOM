...
Node = bitser.registerClass(class("NodeSetCinemaCamera", BaseNode));

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeSetCinemaCamera");
