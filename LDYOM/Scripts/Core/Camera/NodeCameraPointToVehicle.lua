...
Node = bitser.registerClass(class("NodeCameraPointToVehicle", BaseNode));

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeCameraPointToVehicle");
...
function Node:play(data, mission)
	...
	callOpcode(0x0158, {{car,"int"}, {camera_mode,"int"}, {fif(movecam,1,2),"int"}});
