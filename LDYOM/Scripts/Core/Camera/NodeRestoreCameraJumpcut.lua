...
Node = bitser.registerClass(class("NodeRestoreCameraJumpcut", BaseNode));

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeRestoreCameraJumpcut");
