...
Node = bitser.registerClass(class("NodePedIsInWater", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodePedIsInWater");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x04AD, {{ped,"int"}});
end
