...
Node = bitser.registerClass(class("NodePedTurretModeOff", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodePedTurretModeOff");
