...
Node = bitser.registerClass(class("NodePedHasBeenDamagedByCar", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodePedHasBeenDamagedByCar");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x051B, {{ped,"int"}, {vehicle,"int"}});
end
