...
Node = bitser.registerClass(class("NodePedAddAmmo", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodePedAddAmmo");
...
function Node:play(data, mission)
	...
	callOpcode(0x0114, {{ped,"int"}, {ldyom.ID_Weapons[weapon+1],"int"}, {ammo, "int"}});
