...
Node = bitser.registerClass(class("NodePedSetBleeding", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodePedSetBleeding");
...
function Node:play(data, mission)
	...
	callOpcode(0x0332, {{ped,"int"}, {value,"bool"}});
end
