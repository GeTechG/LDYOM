...
Node = bitser.registerClass(class("NodePedTurretModeCar", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodePedTurretModeCar");
...
function Node:play(data, mission)
	...
	callOpcode(0x0464, {{ped,"int"}, {vehicle,"int"}, {offset_x,"float"}, {offset_y,"float"}, {offset_z,"float"}, {direction,"int"}, {angleLimit,"float"}, {ldyom.ID_Weapons[weapon+1],"int"}});
