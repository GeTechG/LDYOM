...
Node = bitser.registerClass(class("NodeSetPosChar", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeSetPosChar");
...
function Node:play(data, mission)
	...
	callOpcode(0x00A1, {{ped,"int"}, {x,"float"}, {y,"float"}, {z,"float"}});
