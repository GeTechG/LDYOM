...
Node = bitser.registerClass(class("NodePedHasBeenPhotographed", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodePedHasBeenPhotographed");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x04C5, {{ped,"int"}});
end
