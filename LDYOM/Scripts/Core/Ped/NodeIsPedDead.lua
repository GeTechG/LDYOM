...
Node = bitser.registerClass(class("NodeIsPedDead", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodeIsPedDead");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x0118, {{ped,"int"}});
end
