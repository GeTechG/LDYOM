...
Node = bitser.registerClass(class("NodePedIsOnScreen", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("fork")..' '..ldyom.langt("CoreNodePedIsOnScreen");
...
function Node:play(data, mission)
	...
	result[0] = callOpcode(0x02CB, {{ped,"int"}});
end
