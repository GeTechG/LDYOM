...
Node = bitser.registerClass(class("NodePedGetCurrentWeapon", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodePedGetCurrentWeapon");
...
function Node:play(data, mission)
	...
	callOpcode(0x0470, {{ped,"int"}, {self.Pins[self.id+2].value,"int*"}});
end
