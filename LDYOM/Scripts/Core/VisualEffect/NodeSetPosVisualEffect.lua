...
Node = bitser.registerClass(class("NodeSetPosVisualEffect", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeSetPosVisualEffect");
...
function Node:play(data, mission)
	...
	ldyom.setPosVisualEffect(mission.list_visualEffects[effect+1], x, y, z);
