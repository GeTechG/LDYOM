...
Node = bitser.registerClass(class("NodeDisapperVisualEffect", BaseNode));
Node.static.mission = true;

Node.static.name = imgui.imnodes.getNodeIcon("event")..' '..ldyom.langt("CoreNodeDisapperVisualEffect");
