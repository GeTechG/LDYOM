...
Node = bitser.registerClass(class("NodeBoolInvert", BaseNode));

Node.static.name = imgui.imnodes.getNodeIcon("func")..' '..ldyom.langt("CoreNodeBoolInvert");
...
function Node:play(data, mission)
	...
	self.Pins[self.id+2].value[0] = not value;
end
