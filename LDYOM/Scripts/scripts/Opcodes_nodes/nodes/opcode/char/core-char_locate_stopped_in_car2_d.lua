...
---@class LDNodeEditorCharLocateStoppedInCar2DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
...
local CHAR_LOCATE_STOPPED_IN_CAR2_D_NODE_TYPE = "core.char_locate_stopped_in_car2_d"

---@type LDNodeEditorNodeType
local charLocateStoppedInCar2DNode = {
    typeName = CHAR_LOCATE_STOPPED_IN_CAR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateStoppedInCar2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_STOPPED_IN_CAR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateStoppedInCar2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateStoppedInCar2D(self_, x, y, xRadius, yRadius, drawSphere)
        return {result}
    end
}

return charLocateStoppedInCar2DNode
