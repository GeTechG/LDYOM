...
---@class LDNodeEditorCharIsStoppedInArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_AREA3_D_NODE_TYPE = "core.char_is_stopped_in_area3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInArea3DNode = {
    typeName = CHAR_IS_STOPPED_IN_AREA3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInArea3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_AREA3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInArea3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInArea3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInArea3DNode
