...
---@class LDNodeEditorCharAddArmorNode : LDNodeEditorNode
---@field self_ integer
---@field amount integer

local CHAR_ADD_ARMOR_NODE_TYPE = "core.char_add_armor"

---@type LDNodeEditorNodeType
local charAddArmorNode = {
    typeName = CHAR_ADD_ARMOR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharAddArmorNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_ADD_ARMOR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
