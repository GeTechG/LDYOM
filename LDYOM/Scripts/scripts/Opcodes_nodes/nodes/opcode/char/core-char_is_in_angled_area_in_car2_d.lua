...
---@class LDNodeEditorCharIsInAngledAreaInCar2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_ANGLED_AREA_IN_CAR2_D_NODE_TYPE = "core.char_is_in_angled_area_in_car2_d"

---@type LDNodeEditorNodeType
local charIsInAngledAreaInCar2DNode = {
    typeName = CHAR_IS_IN_ANGLED_AREA_IN_CAR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAngledAreaInCar2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_ANGLED_AREA_IN_CAR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAngledAreaInCar2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isInAngledAreaInCar2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, angle, drawSphere)
        return {result}
    end
}

return charIsInAngledAreaInCar2DNode
