...
---@class LDNodeEditorCharLocateStoppedAnyMeans2DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
...
local CHAR_LOCATE_STOPPED_ANY_MEANS2_D_NODE_TYPE = "core.char_locate_stopped_any_means2_d"

---@type LDNodeEditorNodeType
local charLocateStoppedAnyMeans2DNode = {
    typeName = CHAR_LOCATE_STOPPED_ANY_MEANS2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateStoppedAnyMeans2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_STOPPED_ANY_MEANS2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateStoppedAnyMeans2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateStoppedAnyMeans2D(self_, x, y, xRadius, yRadius, drawSphere)
        return {result}
    end
}

return charLocateStoppedAnyMeans2DNode
