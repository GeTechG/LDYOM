...
---@class LDNodeEditorCharLocateOnFootObject2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ON_FOOT_OBJECT2_D_NODE_TYPE = "core.char_locate_on_foot_object2_d"

---@type LDNodeEditorNodeType
local charLocateOnFootObject2DNode = {
    typeName = CHAR_LOCATE_ON_FOOT_OBJECT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateOnFootObject2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ON_FOOT_OBJECT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateOnFootObject2D(self_, object, xRadius, yRadius, drawSphere)
        return {1, result}
    end
}

return charLocateOnFootObject2DNode
