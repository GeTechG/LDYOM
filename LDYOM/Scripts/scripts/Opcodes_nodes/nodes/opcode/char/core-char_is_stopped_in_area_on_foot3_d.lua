...
---@class LDNodeEditorCharIsStoppedInAreaOnFoot3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_AREA_ON_FOOT3_D_NODE_TYPE = "core.char_is_stopped_in_area_on_foot3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAreaOnFoot3DNode = {
    typeName = CHAR_IS_STOPPED_IN_AREA_ON_FOOT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAreaOnFoot3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_AREA_ON_FOOT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAreaOnFoot3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAreaOnFoot3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {result}
    end
}

return charIsStoppedInAreaOnFoot3DNode
