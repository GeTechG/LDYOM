...
---@class LDNodeEditorCharIsStoppedInAreaInCar3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_AREA_IN_CAR3_D_NODE_TYPE = "core.char_is_stopped_in_area_in_car3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAreaInCar3DNode = {
    typeName = CHAR_IS_STOPPED_IN_AREA_IN_CAR3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAreaInCar3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_AREA_IN_CAR3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAreaInCar3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAreaInCar3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInAreaInCar3DNode
