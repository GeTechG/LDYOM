...
---@class LDNodeEditorCharHasGotWeaponNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer

local CHAR_HAS_GOT_WEAPON_NODE_TYPE = "core.char_has_got_weapon"

---@type LDNodeEditorNodeType
local charHasGotWeaponNode = {
    typeName = CHAR_HAS_GOT_WEAPON_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharHasGotWeaponNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_HAS_GOT_WEAPON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
