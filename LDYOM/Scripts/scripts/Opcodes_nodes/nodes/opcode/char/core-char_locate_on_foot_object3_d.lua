...
---@class LDNodeEditorCharLocateOnFootObject3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ON_FOOT_OBJECT3_D_NODE_TYPE = "core.char_locate_on_foot_object3_d"

---@type LDNodeEditorNodeType
local charLocateOnFootObject3DNode = {
    typeName = CHAR_LOCATE_ON_FOOT_OBJECT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateOnFootObject3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ON_FOOT_OBJECT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateOnFootObject3DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.locateOnFootObject3D(self_, object, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return charLocateOnFootObject3DNode
