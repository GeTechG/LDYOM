...
---@class LDNodeEditorCharIsInAreaOnFoot3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_AREA_ON_FOOT3_D_NODE_TYPE = "core.char_is_in_area_on_foot3_d"

---@type LDNodeEditorNodeType
local charIsInAreaOnFoot3DNode = {
    typeName = CHAR_IS_IN_AREA_ON_FOOT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAreaOnFoot3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_AREA_ON_FOOT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAreaOnFoot3DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.isInAreaOnFoot3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {1, result}
    end
}

return charIsInAreaOnFoot3DNode
