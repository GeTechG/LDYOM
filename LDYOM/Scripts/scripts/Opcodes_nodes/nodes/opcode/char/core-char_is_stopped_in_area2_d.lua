...
---@class LDNodeEditorCharIsStoppedInArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE = "core.char_is_stopped_in_area2_d"

---@type LDNodeEditorNodeType
local charIsStoppedInArea2DNode = {
    typeName = CHAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInArea2DNode
