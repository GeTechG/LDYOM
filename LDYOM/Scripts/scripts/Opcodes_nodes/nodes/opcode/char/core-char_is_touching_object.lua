...
---@class LDNodeEditorCharIsTouchingObjectNode : LDNodeEditorNode
---@field self_ integer
---@field object integer

local CHAR_IS_TOUCHING_OBJECT_NODE_TYPE = "core.char_is_touching_object"

---@type LDNodeEditorNodeType
local charIsTouchingObjectNode = {
    typeName = CHAR_IS_TOUCHING_OBJECT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsTouchingObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_TOUCHING_OBJECT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return charIsTouchingObjectNode
