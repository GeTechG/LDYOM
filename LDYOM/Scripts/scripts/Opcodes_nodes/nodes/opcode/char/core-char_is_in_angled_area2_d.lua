...
---@class LDNodeEditorCharIsInAngledArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_ANGLED_AREA2_D_NODE_TYPE = "core.char_is_in_angled_area2_d"

---@type LDNodeEditorNodeType
local charIsInAngledArea2DNode = {
    typeName = CHAR_IS_IN_ANGLED_AREA2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAngledArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_ANGLED_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAngledArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isInAngledArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, angle, drawSphere)
        return {1, result}
    end
}

return charIsInAngledArea2DNode
