...
---@class LDNodeEditorCharIsInAreaOnFoot2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_AREA_ON_FOOT2_D_NODE_TYPE = "core.char_is_in_area_on_foot2_d"

---@type LDNodeEditorNodeType
local charIsInAreaOnFoot2DNode = {
    typeName = CHAR_IS_IN_AREA_ON_FOOT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAreaOnFoot2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_AREA_ON_FOOT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAreaOnFoot2DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.isInAreaOnFoot2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {1, result}
    end
}

return charIsInAreaOnFoot2DNode
