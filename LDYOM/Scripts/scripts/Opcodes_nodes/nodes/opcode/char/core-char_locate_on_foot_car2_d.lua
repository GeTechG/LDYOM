...
---@class LDNodeEditorCharLocateOnFootCar2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ON_FOOT_CAR2_D_NODE_TYPE = "core.char_locate_on_foot_car2_d"

---@type LDNodeEditorNodeType
local charLocateOnFootCar2DNode = {
    typeName = CHAR_LOCATE_ON_FOOT_CAR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateOnFootCar2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ON_FOOT_CAR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateOnFootCar2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateOnFootCar2D(self_, vehicle, xRadius, yRadius, drawSphere)
        return {result}
    end
}

return charLocateOnFootCar2DNode
