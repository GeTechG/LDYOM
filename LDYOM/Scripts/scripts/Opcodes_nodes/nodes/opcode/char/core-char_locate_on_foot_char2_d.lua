...
---@class LDNodeEditorCharLocateOnFootChar2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ON_FOOT_CHAR2_D_NODE_TYPE = "core.char_locate_on_foot_char2_d"

---@type LDNodeEditorNodeType
local charLocateOnFootChar2DNode = {
    typeName = CHAR_LOCATE_ON_FOOT_CHAR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateOnFootChar2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ON_FOOT_CHAR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateOnFootChar2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateOnFootChar2D(self_, target, xRadius, yRadius, drawSphere)
        return {result}
    end
}

return charLocateOnFootChar2DNode
