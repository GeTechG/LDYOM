...
---@class LDNodeEditorCharLocateInCarCar3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_IN_CAR_CAR3_D_NODE_TYPE = "core.char_locate_in_car_car3_d"

---@type LDNodeEditorNodeType
local charLocateInCarCar3DNode = {
    typeName = CHAR_LOCATE_IN_CAR_CAR3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateInCarCar3DNode
        local newNode = {
            id = newNodeId,
...
return charLocateInCarCar3DNode
