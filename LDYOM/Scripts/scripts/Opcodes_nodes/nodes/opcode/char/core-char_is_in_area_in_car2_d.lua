...
---@class LDNodeEditorCharIsInAreaInCar2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_AREA_IN_CAR2_D_NODE_TYPE = "core.char_is_in_area_in_car2_d"

---@type LDNodeEditorNodeType
local charIsInAreaInCar2DNode = {
    typeName = CHAR_IS_IN_AREA_IN_CAR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAreaInCar2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_AREA_IN_CAR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAreaInCar2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isInAreaInCar2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {result}
    end
}

return charIsInAreaInCar2DNode
