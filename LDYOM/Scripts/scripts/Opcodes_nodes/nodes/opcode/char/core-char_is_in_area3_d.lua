...
---@class LDNodeEditorCharIsInArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_AREA3_D_NODE_TYPE = "core.char_is_in_area3_d"

---@type LDNodeEditorNodeType
local charIsInArea3DNode = {
    typeName = CHAR_IS_IN_AREA3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInArea3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_AREA3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInArea3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isInArea3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {1, result}
    end
}

return charIsInArea3DNode
