...
---@class LDNodeEditorCharGiveWeaponNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer
---@field ammo integer

local CHAR_GIVE_WEAPON_NODE_TYPE = "core.char_give_weapon"

---@type LDNodeEditorNodeType
local charGiveWeaponNode = {
    typeName = CHAR_GIVE_WEAPON_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharGiveWeaponNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_GIVE_WEAPON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharGiveWeaponNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CharOp.giveWeapon(self_, weaponType, math.floor(ammo))
        return {1}
    end
}

return charGiveWeaponNode
