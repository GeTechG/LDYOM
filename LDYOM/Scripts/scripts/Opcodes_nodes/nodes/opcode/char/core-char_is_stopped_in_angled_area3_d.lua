...
---@class LDNodeEditorCharIsStoppedInAngledArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_ANGLED_AREA3_D_NODE_TYPE = "core.char_is_stopped_in_angled_area3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAngledArea3DNode = {
    typeName = CHAR_IS_STOPPED_IN_ANGLED_AREA3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAngledArea3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_ANGLED_AREA3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAngledArea3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAngledArea3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, angle, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInAngledArea3DNode
