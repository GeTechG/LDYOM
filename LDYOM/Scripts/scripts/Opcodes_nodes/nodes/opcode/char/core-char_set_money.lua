...
---@class LDNodeEditorCharSetMoneyNode : LDNodeEditorNode
---@field self_ integer
---@field amount integer

local CHAR_SET_MONEY_NODE_TYPE = "core.char_set_money"

---@type LDNodeEditorNodeType
local charSetMoneyNode = {
    typeName = CHAR_SET_MONEY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetMoneyNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_MONEY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
