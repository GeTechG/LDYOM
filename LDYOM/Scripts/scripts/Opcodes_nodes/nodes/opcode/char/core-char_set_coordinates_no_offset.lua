...
---@class LDNodeEditorCharSetCoordinatesNoOffsetNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHAR_SET_COORDINATES_NO_OFFSET_NODE_TYPE = "core.char_set_coordinates_no_offset"

---@type LDNodeEditorNodeType
local charSetCoordinatesNoOffsetNode = {
    typeName = CHAR_SET_COORDINATES_NO_OFFSET_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetCoordinatesNoOffsetNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_COORDINATES_NO_OFFSET_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetCoordinatesNoOffsetNode
    ...
    run = function(editor, node, inputValues)
		...
		CharOp.setCoordinatesNoOffset(self_, x, y, z)
        return {1}
    end
}

return charSetCoordinatesNoOffsetNode
