...
---@class LDNodeEditorCharIsStoppedInAngledAreaInCar3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_ANGLED_AREA_IN_CAR3_D_NODE_TYPE = "core.char_is_stopped_in_angled_area_in_car3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAngledAreaInCar3DNode = {
    typeName = CHAR_IS_STOPPED_IN_ANGLED_AREA_IN_CAR3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAngledAreaInCar3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_ANGLED_AREA_IN_CAR3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAngledAreaInCar3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAngledAreaInCar3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, angle, drawSphere)
        return {result}
    end
}

return charIsStoppedInAngledAreaInCar3DNode
