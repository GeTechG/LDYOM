...
---@class LDNodeEditorCharHasBeenDamagedByWeaponNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer

local CHAR_HAS_BEEN_DAMAGED_BY_WEAPON_NODE_TYPE = "core.char_has_been_damaged_by_weapon"

---@type LDNodeEditorNodeType
local charHasBeenDamagedByWeaponNode = {
    typeName = CHAR_HAS_BEEN_DAMAGED_BY_WEAPON_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharHasBeenDamagedByWeaponNode
        local newNode = {
            id = newNodeId,
...
return charHasBeenDamagedByWeaponNode
