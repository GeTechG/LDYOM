...
---@class LDNodeEditorCharSetAmmoNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer
---@field ammo integer

local CHAR_SET_AMMO_NODE_TYPE = "core.char_set_ammo"

---@type LDNodeEditorNodeType
local charSetAmmoNode = {
    typeName = CHAR_SET_AMMO_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetAmmoNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_AMMO_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
