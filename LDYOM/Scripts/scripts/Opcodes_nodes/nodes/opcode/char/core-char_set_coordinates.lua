...
---@class LDNodeEditorCharSetCoordinatesNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHAR_SET_COORDINATES_NODE_TYPE = "core.char_set_coordinates"

---@type LDNodeEditorNodeType
local charSetCoordinatesNode = {
    typeName = CHAR_SET_COORDINATES_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetCoordinatesNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_COORDINATES_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetCoordinatesNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CharOp.setCoordinates(self_, x, y, z)
        return {1}
    end
}

return charSetCoordinatesNode
