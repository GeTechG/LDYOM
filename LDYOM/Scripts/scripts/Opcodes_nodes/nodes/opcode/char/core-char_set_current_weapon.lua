...
---@class LDNodeEditorCharSetCurrentWeaponNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer

local CHAR_SET_CURRENT_WEAPON_NODE_TYPE = "core.char_set_current_weapon"

---@type LDNodeEditorNodeType
local charSetCurrentWeaponNode = {
    typeName = CHAR_SET_CURRENT_WEAPON_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetCurrentWeaponNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_CURRENT_WEAPON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return charSetCurrentWeaponNode
