...
---@class LDNodeEditorCharLocateInCarChar3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_IN_CAR_CHAR3_D_NODE_TYPE = "core.char_locate_in_car_char3_d"

---@type LDNodeEditorNodeType
local charLocateInCarChar3DNode = {
    typeName = CHAR_LOCATE_IN_CAR_CHAR3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateInCarChar3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_IN_CAR_CHAR3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateInCarChar3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateInCarChar3D(self_, target, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return charLocateInCarChar3DNode
