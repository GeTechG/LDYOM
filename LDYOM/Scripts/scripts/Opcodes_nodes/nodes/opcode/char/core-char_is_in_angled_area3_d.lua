...
---@class LDNodeEditorCharIsInAngledArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_ANGLED_AREA3_D_NODE_TYPE = "core.char_is_in_angled_area3_d"

---@type LDNodeEditorNodeType
local charIsInAngledArea3DNode = {
    typeName = CHAR_IS_IN_ANGLED_AREA3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAngledArea3DNode
        local newNode = {
            id = newNodeId,
...
return charIsInAngledArea3DNode
