...
---@class LDNodeEditorCharLocateStoppedOnFoot3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CHAR_LOCATE_STOPPED_ON_FOOT3_D_NODE_TYPE = "core.char_locate_stopped_on_foot3_d"

---@type LDNodeEditorNodeType
local charLocateStoppedOnFoot3DNode = {
    typeName = CHAR_LOCATE_STOPPED_ON_FOOT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateStoppedOnFoot3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_STOPPED_ON_FOOT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateStoppedOnFoot3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateStoppedOnFoot3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return charLocateStoppedOnFoot3DNode
