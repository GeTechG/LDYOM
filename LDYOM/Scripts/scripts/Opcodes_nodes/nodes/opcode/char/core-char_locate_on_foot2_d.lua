...
---@class LDNodeEditorCharLocateOnFoot2DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
...
local CHAR_LOCATE_ON_FOOT2_D_NODE_TYPE = "core.char_locate_on_foot2_d"

---@type LDNodeEditorNodeType
local charLocateOnFoot2DNode = {
    typeName = CHAR_LOCATE_ON_FOOT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateOnFoot2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ON_FOOT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateOnFoot2DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.locateOnFoot2D(self_, x, y, xRadius, yRadius, drawSphere)
        return {1, result}
    end
}

return charLocateOnFoot2DNode
