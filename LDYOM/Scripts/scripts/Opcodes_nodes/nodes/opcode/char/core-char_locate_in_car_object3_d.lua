...
---@class LDNodeEditorCharLocateInCarObject3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_IN_CAR_OBJECT3_D_NODE_TYPE = "core.char_locate_in_car_object3_d"

---@type LDNodeEditorNodeType
local charLocateInCarObject3DNode = {
    typeName = CHAR_LOCATE_IN_CAR_OBJECT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateInCarObject3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_IN_CAR_OBJECT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateInCarObject3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateInCarObject3D(self_, object, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return charLocateInCarObject3DNode
