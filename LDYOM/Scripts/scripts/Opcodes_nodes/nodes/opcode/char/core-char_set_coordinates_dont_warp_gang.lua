...
---@class LDNodeEditorCharSetCoordinatesDontWarpGangNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHAR_SET_COORDINATES_DONT_WARP_GANG_NODE_TYPE = "core.char_set_coordinates_dont_warp_gang"

---@type LDNodeEditorNodeType
local charSetCoordinatesDontWarpGangNode = {
    typeName = CHAR_SET_COORDINATES_DONT_WARP_GANG_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetCoordinatesDontWarpGangNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_COORDINATES_DONT_WARP_GANG_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetCoordinatesDontWarpGangNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CharOp.setCoordinatesDontWarpGang(self_, x, y, z)
        return {1}
    end
}

return charSetCoordinatesDontWarpGangNode
