...
---@class LDNodeEditorCharIsInModelNode : LDNodeEditorNode
---@field self_ integer
---@field modelId integer

local CHAR_IS_IN_MODEL_NODE_TYPE = "core.char_is_in_model"

---@type LDNodeEditorNodeType
local charIsInModelNode = {
    typeName = CHAR_IS_IN_MODEL_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInModelNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_MODEL_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
