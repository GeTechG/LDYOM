...
---@class LDNodeEditorCharLocateStoppedAnyMeans3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CHAR_LOCATE_STOPPED_ANY_MEANS3_D_NODE_TYPE = "core.char_locate_stopped_any_means3_d"

---@type LDNodeEditorNodeType
local charLocateStoppedAnyMeans3DNode = {
    typeName = CHAR_LOCATE_STOPPED_ANY_MEANS3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateStoppedAnyMeans3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_STOPPED_ANY_MEANS3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateStoppedAnyMeans3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateStoppedAnyMeans3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {result}
    end
}

return charLocateStoppedAnyMeans3DNode
