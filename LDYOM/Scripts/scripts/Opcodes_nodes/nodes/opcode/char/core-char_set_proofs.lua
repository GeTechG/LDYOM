...
---@class LDNodeEditorCharSetProofsNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_SET_PROOFS_NODE_TYPE = "core.char_set_proofs"

---@type LDNodeEditorNodeType
local charSetProofsNode = {
    typeName = CHAR_SET_PROOFS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetProofsNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_PROOFS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetProofsNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CharOp.setProofs(self_, bulletProof, fireProof, explosionProof, collisionProof, meleeProof)
        return {1}
    end
}

return charSetProofsNode
