...
---@class LDNodeEditorCharLocateAnyMeansObject2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ANY_MEANS_OBJECT2_D_NODE_TYPE = "core.char_locate_any_means_object2_d"

---@type LDNodeEditorNodeType
local charLocateAnyMeansObject2DNode = {
    typeName = CHAR_LOCATE_ANY_MEANS_OBJECT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateAnyMeansObject2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ANY_MEANS_OBJECT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateAnyMeansObject2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateAnyMeansObject2D(self_, object, xRadius, yRadius, drawSphere)
        return {result}
    end
}

return charLocateAnyMeansObject2DNode
