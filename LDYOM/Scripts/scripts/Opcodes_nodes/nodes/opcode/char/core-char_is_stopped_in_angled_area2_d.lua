...
---@class LDNodeEditorCharIsStoppedInAngledArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_ANGLED_AREA2_D_NODE_TYPE = "core.char_is_stopped_in_angled_area2_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAngledArea2DNode = {
    typeName = CHAR_IS_STOPPED_IN_ANGLED_AREA2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAngledArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_ANGLED_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAngledArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAngledArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, angle, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInAngledArea2DNode
