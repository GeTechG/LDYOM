...
---@class LDNodeEditorCharLocateInCar3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CHAR_LOCATE_IN_CAR3_D_NODE_TYPE = "core.char_locate_in_car3_d"

---@type LDNodeEditorNodeType
local charLocateInCar3DNode = {
    typeName = CHAR_LOCATE_IN_CAR3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateInCar3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_IN_CAR3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateInCar3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateInCar3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {result}
    end
}

return charLocateInCar3DNode
