...
---@class LDNodeEditorCharIsInAngledAreaOnFoot2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_IN_ANGLED_AREA_ON_FOOT2_D_NODE_TYPE = "core.char_is_in_angled_area_on_foot2_d"

---@type LDNodeEditorNodeType
local charIsInAngledAreaOnFoot2DNode = {
    typeName = CHAR_IS_IN_ANGLED_AREA_ON_FOOT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsInAngledAreaOnFoot2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_IN_ANGLED_AREA_ON_FOOT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsInAngledAreaOnFoot2DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.isInAngledAreaOnFoot2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, angle, drawSphere)
        return {1, result}
    end
}

return charIsInAngledAreaOnFoot2DNode
