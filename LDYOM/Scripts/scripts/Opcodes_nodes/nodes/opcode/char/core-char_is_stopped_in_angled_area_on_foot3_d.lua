...
---@class LDNodeEditorCharIsStoppedInAngledAreaOnFoot3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_ANGLED_AREA_ON_FOOT3_D_NODE_TYPE = "core.char_is_stopped_in_angled_area_on_foot3_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAngledAreaOnFoot3DNode = {
    typeName = CHAR_IS_STOPPED_IN_ANGLED_AREA_ON_FOOT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAngledAreaOnFoot3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_ANGLED_AREA_ON_FOOT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAngledAreaOnFoot3DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.isStoppedInAngledAreaOnFoot3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, angle, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInAngledAreaOnFoot3DNode
