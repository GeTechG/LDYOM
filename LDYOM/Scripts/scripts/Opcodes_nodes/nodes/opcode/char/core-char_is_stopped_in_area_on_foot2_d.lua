...
---@class LDNodeEditorCharIsStoppedInAreaOnFoot2DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_IS_STOPPED_IN_AREA_ON_FOOT2_D_NODE_TYPE = "core.char_is_stopped_in_area_on_foot2_d"

---@type LDNodeEditorNodeType
local charIsStoppedInAreaOnFoot2DNode = {
    typeName = CHAR_IS_STOPPED_IN_AREA_ON_FOOT2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharIsStoppedInAreaOnFoot2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_IS_STOPPED_IN_AREA_ON_FOOT2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharIsStoppedInAreaOnFoot2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.isStoppedInAreaOnFoot2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {1, result}
    end
}

return charIsStoppedInAreaOnFoot2DNode
