...
---@class LDNodeEditorCharLocateAnyMeans3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CHAR_LOCATE_ANY_MEANS3_D_NODE_TYPE = "core.char_locate_any_means3_d"

---@type LDNodeEditorNodeType
local charLocateAnyMeans3DNode = {
    typeName = CHAR_LOCATE_ANY_MEANS3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateAnyMeans3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ANY_MEANS3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateAnyMeans3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateAnyMeans3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {result}
    end
}

return charLocateAnyMeans3DNode
