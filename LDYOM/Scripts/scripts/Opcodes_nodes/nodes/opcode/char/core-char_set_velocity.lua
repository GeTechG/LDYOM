...
---@class LDNodeEditorCharSetVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHAR_SET_VELOCITY_NODE_TYPE = "core.char_set_velocity"

---@type LDNodeEditorNodeType
local charSetVelocityNode = {
    typeName = CHAR_SET_VELOCITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharSetVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_SET_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharSetVelocityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CharOp.setVelocity(self_, x, y, z)
        return {1}
    end
}

return charSetVelocityNode
