...
---@class LDNodeEditorCharLocateAnyMeans2DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
...
local CHAR_LOCATE_ANY_MEANS2_D_NODE_TYPE = "core.char_locate_any_means2_d"

---@type LDNodeEditorNodeType
local charLocateAnyMeans2DNode = {
    typeName = CHAR_LOCATE_ANY_MEANS2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateAnyMeans2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ANY_MEANS2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateAnyMeans2DNode
    ...
    run = function(editor, node, inputValues)
		...
		local result = CharOp.locateAnyMeans2D(self_, x, y, xRadius, yRadius, drawSphere)
        return {1, result}
    end
}

return charLocateAnyMeans2DNode
