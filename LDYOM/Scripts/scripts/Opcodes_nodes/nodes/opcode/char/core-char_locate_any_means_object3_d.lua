...
---@class LDNodeEditorCharLocateAnyMeansObject3DNode : LDNodeEditorNode
---@field self_ integer
...
local CHAR_LOCATE_ANY_MEANS_OBJECT3_D_NODE_TYPE = "core.char_locate_any_means_object3_d"

---@type LDNodeEditorNodeType
local charLocateAnyMeansObject3DNode = {
    typeName = CHAR_LOCATE_ANY_MEANS_OBJECT3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCharLocateAnyMeansObject3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CHAR_LOCATE_ANY_MEANS_OBJECT3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCharLocateAnyMeansObject3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CharOp.locateAnyMeansObject3D(self_, object, xRadius, yRadius, zRadius, drawSphere)
        return {1, result}
    end
}

return charLocateAnyMeansObject3DNode
