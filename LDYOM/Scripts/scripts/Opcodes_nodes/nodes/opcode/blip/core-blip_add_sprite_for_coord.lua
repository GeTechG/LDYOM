...
---@class LDNodeEditorBlipAddSpriteForCoordNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field sprite integer

local BLIP_ADD_SPRITE_FOR_COORD_NODE_TYPE = "core.blip_add_sprite_for_coord"

---@type LDNodeEditorNodeType
local blipAddSpriteForCoordNode = {
    typeName = BLIP_ADD_SPRITE_FOR_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorBlipAddSpriteForCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = BLIP_ADD_SPRITE_FOR_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorBlipAddSpriteForCoordNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local handle = BlipOp.addSpriteForCoord(x, y, z, sprite)
        return {1, handle}
    end
}

return blipAddSpriteForCoordNode
