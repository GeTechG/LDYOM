...
---@class LDNodeEditorBlipSetEntryExitNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field radius number

local BLIP_SET_ENTRY_EXIT_NODE_TYPE = "core.blip_set_entry_exit"

---@type LDNodeEditorNodeType
local blipSetEntryExitNode = {
    typeName = BLIP_SET_ENTRY_EXIT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorBlipSetEntryExitNode
        local newNode = {
            id = newNodeId,
            nodeType = BLIP_SET_ENTRY_EXIT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorBlipSetEntryExitNode
    ...
    run = function(editor, context, node, inputValues)
		...
		BlipOp.setEntryExit(self_, x, y, radius)
        return {1}
    end
}

return blipSetEntryExitNode
