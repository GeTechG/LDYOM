...
---@class LDNodeEditorBlipAddShortRangeSpriteForContactPointNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field sprite integer

local BLIP_ADD_SHORT_RANGE_SPRITE_FOR_CONTACT_POINT_NODE_TYPE = "core.blip_add_short_range_sprite_for_contact_point"

---@type LDNodeEditorNodeType
local blipAddShortRangeSpriteForContactPointNode = {
    typeName = BLIP_ADD_SHORT_RANGE_SPRITE_FOR_CONTACT_POINT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorBlipAddShortRangeSpriteForContactPointNode
        local newNode = {
            id = newNodeId,
            nodeType = BLIP_ADD_SHORT_RANGE_SPRITE_FOR_CONTACT_POINT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorBlipAddShortRangeSpriteForContactPointNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local handle = BlipOp.addShortRangeSpriteForContactPoint(x, y, z, sprite)
        return {1, handle}
    end
}

return blipAddShortRangeSpriteForContactPointNode
