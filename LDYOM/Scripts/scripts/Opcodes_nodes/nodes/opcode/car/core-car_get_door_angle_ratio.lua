...
---@class LDNodeEditorCarGetDoorAngleRatioNode : LDNodeEditorNode
---@field self_ integer
---@field door integer

local CAR_GET_DOOR_ANGLE_RATIO_NODE_TYPE = "core.car_get_door_angle_ratio"

---@type LDNodeEditorNodeType
local carGetDoorAngleRatioNode = {
    typeName = CAR_GET_DOOR_ANGLE_RATIO_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarGetDoorAngleRatioNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_GET_DOOR_ANGLE_RATIO_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    draw = function(editor, ctx, node, builder)
		...
		LDNodeEditor.defaultOutput(editor, ctx, builder, node.outputs[2], "ratio");
...
return carGetDoorAngleRatioNode
