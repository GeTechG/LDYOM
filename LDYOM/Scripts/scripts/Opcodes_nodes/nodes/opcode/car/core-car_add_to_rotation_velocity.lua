...
---@class LDNodeEditorCarAddToRotationVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_ADD_TO_ROTATION_VELOCITY_NODE_TYPE = "core.car_add_to_rotation_velocity"

---@type LDNodeEditorNodeType
local carAddToRotationVelocityNode = {
    typeName = CAR_ADD_TO_ROTATION_VELOCITY_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarAddToRotationVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_ADD_TO_ROTATION_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarAddToRotationVelocityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.addToRotationVelocity(self_, x, y, z)
        return {1}
    end
}

return carAddToRotationVelocityNode
