...
---@class LDNodeEditorCarSetRotationVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_SET_ROTATION_VELOCITY_NODE_TYPE = "core.car_set_rotation_velocity"

---@type LDNodeEditorNodeType
local carSetRotationVelocityNode = {
    typeName = CAR_SET_ROTATION_VELOCITY_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarSetRotationVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_SET_ROTATION_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarSetRotationVelocityNode
    ...
    run = function(editor, node, inputValues)
		...
		CarOp.setRotationVelocity(self_, x, y, z)
        return {1}
    end
}

return carSetRotationVelocityNode
