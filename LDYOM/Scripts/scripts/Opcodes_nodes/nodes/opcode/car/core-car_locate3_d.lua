...
---@class LDNodeEditorCarLocate3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CAR_LOCATE3_D_NODE_TYPE = "core.car_locate3_d"

---@type LDNodeEditorNodeType
local carLocate3DNode = {
    typeName = CAR_LOCATE3_D_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarLocate3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_LOCATE3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarLocate3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CarOp.locate3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {result}
    end
}

return carLocate3DNode
