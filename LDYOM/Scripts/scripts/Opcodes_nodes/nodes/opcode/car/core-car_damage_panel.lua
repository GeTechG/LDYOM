...
---@class LDNodeEditorCarDamagePanelNode : LDNodeEditorNode
---@field self_ integer
---@field panelId integer

local CAR_DAMAGE_PANEL_NODE_TYPE = "core.car_damage_panel"

---@type LDNodeEditorNodeType
local carDamagePanelNode = {
    typeName = CAR_DAMAGE_PANEL_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarDamagePanelNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_DAMAGE_PANEL_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
