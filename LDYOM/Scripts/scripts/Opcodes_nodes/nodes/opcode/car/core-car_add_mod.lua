...
---@class LDNodeEditorCarAddModNode : LDNodeEditorNode
---@field self_ integer
---@field modelId integer

local CAR_ADD_MOD_NODE_TYPE = "core.car_add_mod"

---@type LDNodeEditorNodeType
local carAddModNode = {
    typeName = CAR_ADD_MOD_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarAddModNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_ADD_MOD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarAddModNode
