...
---@class LDNodeEditorCarSetCoordinatesNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_SET_COORDINATES_NODE_TYPE = "core.car_set_coordinates"

---@type LDNodeEditorNodeType
local carSetCoordinatesNode = {
    typeName = CAR_SET_COORDINATES_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarSetCoordinatesNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_SET_COORDINATES_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarSetCoordinatesNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.setCoordinates(self_, x, y, z)
        return {1}
    end
}

return carSetCoordinatesNode
