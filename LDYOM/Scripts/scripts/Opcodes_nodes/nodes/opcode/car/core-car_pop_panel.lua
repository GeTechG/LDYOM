...
---@class LDNodeEditorCarPopPanelNode : LDNodeEditorNode
---@field self_ integer
---@field panelId integer
---@field visibility boolean

local CAR_POP_PANEL_NODE_TYPE = "core.car_pop_panel"

---@type LDNodeEditorNodeType
local carPopPanelNode = {
    typeName = CAR_POP_PANEL_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarPopPanelNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_POP_PANEL_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
