...
---@class LDNodeEditorCarGotoCoordinatesRacingNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_GOTO_COORDINATES_RACING_NODE_TYPE = "core.car_goto_coordinates_racing"

---@type LDNodeEditorNodeType
local carGotoCoordinatesRacingNode = {
    typeName = CAR_GOTO_COORDINATES_RACING_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarGotoCoordinatesRacingNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_GOTO_COORDINATES_RACING_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarGotoCoordinatesRacingNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.gotoCoordinatesRacing(self_, x, y, z)
        return {1}
    end
}

return carGotoCoordinatesRacingNode
