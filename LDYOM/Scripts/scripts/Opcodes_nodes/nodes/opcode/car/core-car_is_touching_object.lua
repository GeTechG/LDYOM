...
---@class LDNodeEditorCarIsTouchingObjectNode : LDNodeEditorNode
---@field self_ integer
---@field handle integer

local CAR_IS_TOUCHING_OBJECT_NODE_TYPE = "core.car_is_touching_object"

---@type LDNodeEditorNodeType
local carIsTouchingObjectNode = {
    typeName = CAR_IS_TOUCHING_OBJECT_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarIsTouchingObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_IS_TOUCHING_OBJECT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarIsTouchingObjectNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CarOp.isTouchingObject(self_, handle)
        return {result}
    end
}

return carIsTouchingObjectNode
