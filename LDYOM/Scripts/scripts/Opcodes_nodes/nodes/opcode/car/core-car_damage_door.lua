...
---@class LDNodeEditorCarDamageDoorNode : LDNodeEditorNode
---@field self_ integer
---@field door integer

local CAR_DAMAGE_DOOR_NODE_TYPE = "core.car_damage_door"

---@type LDNodeEditorNodeType
local carDamageDoorNode = {
    typeName = CAR_DAMAGE_DOOR_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarDamageDoorNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_DAMAGE_DOOR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarDamageDoorNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.damageDoor(self_, door)
        return {1}
    end
}

return carDamageDoorNode
