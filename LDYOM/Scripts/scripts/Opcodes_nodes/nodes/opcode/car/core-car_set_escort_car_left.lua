...
---@class LDNodeEditorCarSetEscortCarLeftNode : LDNodeEditorNode
---@field self_ integer
---@field handle integer

local CAR_SET_ESCORT_CAR_LEFT_NODE_TYPE = "core.car_set_escort_car_left"

---@type LDNodeEditorNodeType
local carSetEscortCarLeftNode = {
    typeName = CAR_SET_ESCORT_CAR_LEFT_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarSetEscortCarLeftNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_SET_ESCORT_CAR_LEFT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return carSetEscortCarLeftNode
