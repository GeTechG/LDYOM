...
---@class LDNodeEditorCarHasBeenDamagedByWeaponNode : LDNodeEditorNode
---@field self_ integer
---@field weaponType integer

local CAR_HAS_BEEN_DAMAGED_BY_WEAPON_NODE_TYPE = "core.car_has_been_damaged_by_weapon"

---@type LDNodeEditorNodeType
local carHasBeenDamagedByWeaponNode = {
    typeName = CAR_HAS_BEEN_DAMAGED_BY_WEAPON_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarHasBeenDamagedByWeaponNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_HAS_BEEN_DAMAGED_BY_WEAPON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return carHasBeenDamagedByWeaponNode
