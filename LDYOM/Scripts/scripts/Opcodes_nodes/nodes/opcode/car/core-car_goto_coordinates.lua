...
---@class LDNodeEditorCarGotoCoordinatesNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_GOTO_COORDINATES_NODE_TYPE = "core.car_goto_coordinates"

---@type LDNodeEditorNodeType
local carGotoCoordinatesNode = {
    typeName = CAR_GOTO_COORDINATES_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarGotoCoordinatesNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_GOTO_COORDINATES_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarGotoCoordinatesNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.gotoCoordinates(self_, x, y, z)
        return {1}
    end
}

return carGotoCoordinatesNode
