...
---@class LDNodeEditorCarIsInArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local CAR_IS_IN_AREA2_D_NODE_TYPE = "core.car_is_in_area2_d"

---@type LDNodeEditorNodeType
local carIsInArea2DNode = {
    typeName = CAR_IS_IN_AREA2_D_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarIsInArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_IS_IN_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarIsInArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CarOp.isInArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {1, result}
    end
}

return carIsInArea2DNode
