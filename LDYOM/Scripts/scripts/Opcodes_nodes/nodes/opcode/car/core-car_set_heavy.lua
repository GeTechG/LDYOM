...
---@class LDNodeEditorCarSetHeavyNode : LDNodeEditorNode
---@field self_ integer
---@field state boolean

local CAR_SET_HEAVY_NODE_TYPE = "core.car_set_heavy"

---@type LDNodeEditorNodeType
local carSetHeavyNode = {
    typeName = CAR_SET_HEAVY_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarSetHeavyNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_SET_HEAVY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
