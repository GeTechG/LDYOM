...
---@class LDNodeEditorCarGotoCoordinatesAccurateNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CAR_GOTO_COORDINATES_ACCURATE_NODE_TYPE = "core.car_goto_coordinates_accurate"

---@type LDNodeEditorNodeType
local carGotoCoordinatesAccurateNode = {
    typeName = CAR_GOTO_COORDINATES_ACCURATE_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarGotoCoordinatesAccurateNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_GOTO_COORDINATES_ACCURATE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarGotoCoordinatesAccurateNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CarOp.gotoCoordinatesAccurate(self_, x, y, z)
        return {1}
    end
}

return carGotoCoordinatesAccurateNode
