...
---@class LDNodeEditorCarIsStoppedInArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local CAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE = "core.car_is_stopped_in_area2_d"

---@type LDNodeEditorNodeType
local carIsStoppedInArea2DNode = {
    typeName = CAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarIsStoppedInArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_IS_STOPPED_IN_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarIsStoppedInArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CarOp.isStoppedInArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {1, result}
    end
}

return carIsStoppedInArea2DNode
