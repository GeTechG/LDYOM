...
---@class LDNodeEditorCarLocateStopped3DNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local CAR_LOCATE_STOPPED3_D_NODE_TYPE = "core.car_locate_stopped3_d"

---@type LDNodeEditorNodeType
local carLocateStopped3DNode = {
    typeName = CAR_LOCATE_STOPPED3_D_NODE_TYPE,
    category = "opcode.car",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCarLocateStopped3DNode
        local newNode = {
            id = newNodeId,
            nodeType = CAR_LOCATE_STOPPED3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCarLocateStopped3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CarOp.locateStopped3D(self_, x, y, z, xRadius, yRadius, zRadius, drawSphere)
        return {result}
    end
}

return carLocateStopped3DNode
