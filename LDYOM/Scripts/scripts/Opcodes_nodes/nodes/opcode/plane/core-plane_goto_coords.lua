...
---@class LDNodeEditorPlaneGotoCoordsNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local PLANE_GOTO_COORDS_NODE_TYPE = "core.plane_goto_coords"

---@type LDNodeEditorNodeType
local planeGotoCoordsNode = {
    typeName = PLANE_GOTO_COORDS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorPlaneGotoCoordsNode
        local newNode = {
            id = newNodeId,
            nodeType = PLANE_GOTO_COORDS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorPlaneGotoCoordsNode
    ...
    run = function(editor, context, node, inputValues)
		...
		PlaneOp.gotoCoords(self_, x, y, z, minAltitude, maxAltitude)
        return {1}
    end
}

return planeGotoCoordsNode
