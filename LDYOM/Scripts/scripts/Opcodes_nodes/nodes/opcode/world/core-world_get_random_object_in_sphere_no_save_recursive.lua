...
---@class LDNodeEditorWorldGetRandomObjectInSphereNoSaveRecursiveNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field radius number
...
local WORLD_GET_RANDOM_OBJECT_IN_SPHERE_NO_SAVE_RECURSIVE_NODE_TYPE = "core.world_get_random_object_in_sphere_no_save_recursive"

---@type LDNodeEditorNodeType
local worldGetRandomObjectInSphereNoSaveRecursiveNode = {
    typeName = WORLD_GET_RANDOM_OBJECT_IN_SPHERE_NO_SAVE_RECURSIVE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldGetRandomObjectInSphereNoSaveRecursiveNode
        local newNode = {
            id = newNodeId,
...
return worldGetRandomObjectInSphereNoSaveRecursiveNode
