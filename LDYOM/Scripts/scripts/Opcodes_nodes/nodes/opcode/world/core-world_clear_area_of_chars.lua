...
---@class LDNodeEditorWorldClearAreaOfCharsNode : LDNodeEditorNode
...
local WORLD_CLEAR_AREA_OF_CHARS_NODE_TYPE = "core.world_clear_area_of_chars"

---@type LDNodeEditorNodeType
local worldClearAreaOfCharsNode = {
    typeName = WORLD_CLEAR_AREA_OF_CHARS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldClearAreaOfCharsNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_CLEAR_AREA_OF_CHARS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWorldClearAreaOfCharsNode
    ...
    run = function(editor, node, inputValues)
		...
		WorldOp.clearAreaOfChars(leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ)
        return {1}
    end
}

return worldClearAreaOfCharsNode
