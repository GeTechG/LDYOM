...
local worldGetRandomCarInSphereNoSaveRecursiveNode = {
    ...
    draw = function(editor, ctx, node, builder)
		...
		LDNodeEditor.defaultInput(editor, ctx, builder, node.inputs[7], "skipWrecked", function ()
            node.skipWrecked = editor.dataTypes[node.inputs[7].type].drawEditValue(node.skipWrecked, "##skipWreckedEdit", fontScale * 100)
        end);
    ...
    run = function(editor, node, inputValues)
		...
		local skipWrecked = inputValues[7] or node.skipWrecked
