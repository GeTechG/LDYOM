...
---@class LDNodeEditorWorldClearAreaOfCarsNode : LDNodeEditorNode
...
local WORLD_CLEAR_AREA_OF_CARS_NODE_TYPE = "core.world_clear_area_of_cars"

---@type LDNodeEditorNodeType
local worldClearAreaOfCarsNode = {
    typeName = WORLD_CLEAR_AREA_OF_CARS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldClearAreaOfCarsNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_CLEAR_AREA_OF_CARS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWorldClearAreaOfCarsNode
    ...
    run = function(editor, context, node, inputValues)
		...
		WorldOp.clearAreaOfCars(leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ)
        return {1}
    end
}

return worldClearAreaOfCarsNode
