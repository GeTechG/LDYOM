...
---@class LDNodeEditorWorldIsCopVehicleInArea3DNoSaveNode : LDNodeEditorNode
...
local WORLD_IS_COP_VEHICLE_IN_AREA3_D_NO_SAVE_NODE_TYPE = "core.world_is_cop_vehicle_in_area3_d_no_save"

---@type LDNodeEditorNodeType
local worldIsCopVehicleInArea3DNoSaveNode = {
    typeName = WORLD_IS_COP_VEHICLE_IN_AREA3_D_NO_SAVE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldIsCopVehicleInArea3DNoSaveNode
        local newNode = {
            id = newNodeId,
...
return worldIsCopVehicleInArea3DNoSaveNode
