...
---@class LDNodeEditorWorldGetParkingNodeInAreaNode : LDNodeEditorNode
...
local WORLD_GET_PARKING_NODE_IN_AREA_NODE_TYPE = "core.world_get_parking_node_in_area"

---@type LDNodeEditorNodeType
local worldGetParkingNodeInAreaNode = {
    typeName = WORLD_GET_PARKING_NODE_IN_AREA_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWorldGetParkingNodeInAreaNode
        local newNode = {
            id = newNodeId,
            nodeType = WORLD_GET_PARKING_NODE_IN_AREA_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    run = function(editor, node, inputValues)
		...
		local x, y, z = WorldOp.getParkingNodeInArea(leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ)
        return {1, x, y, z}
    end
}

return worldGetParkingNodeInAreaNode
