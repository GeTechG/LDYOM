...
---@class LDNodeEditorHudDisplayTimerWithStringNode : LDNodeEditorNode
---@field timer integer
---@field direction integer
---@field text string

local HUD_DISPLAY_TIMER_WITH_STRING_NODE_TYPE = "core.hud_display_timer_with_string"

---@type LDNodeEditorNodeType
local hudDisplayTimerWithStringNode = {
    typeName = HUD_DISPLAY_TIMER_WITH_STRING_NODE_TYPE,
    category = "opcode.hud",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorHudDisplayTimerWithStringNode
        local newNode = {
            id = newNodeId,
            nodeType = HUD_DISPLAY_TIMER_WITH_STRING_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return hudDisplayTimerWithStringNode
