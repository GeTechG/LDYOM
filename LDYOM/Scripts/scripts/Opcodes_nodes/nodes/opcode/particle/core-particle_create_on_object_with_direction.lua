...
---@class LDNodeEditorParticleCreateOnObjectWithDirectionNode : LDNodeEditorNode
---@field name string
...
local PARTICLE_CREATE_ON_OBJECT_WITH_DIRECTION_NODE_TYPE = "core.particle_create_on_object_with_direction"

---@type LDNodeEditorNodeType
local particleCreateOnObjectWithDirectionNode = {
    typeName = PARTICLE_CREATE_ON_OBJECT_WITH_DIRECTION_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorParticleCreateOnObjectWithDirectionNode
        local newNode = {
            id = newNodeId,
            nodeType = PARTICLE_CREATE_ON_OBJECT_WITH_DIRECTION_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorParticleCreateOnObjectWithDirectionNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local handle = ParticleOp.createOnObjectWithDirection(name, object, xOffset, yOffset, zOffset, xDirection, yDirection, zDirection, math.floor(type))
        return {1, handle}
    end
}

return particleCreateOnObjectWithDirectionNode
