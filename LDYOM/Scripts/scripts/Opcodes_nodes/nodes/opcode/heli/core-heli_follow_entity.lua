...
---@class LDNodeEditorHeliFollowEntityNode : LDNodeEditorNode
---@field self_ integer
---@field char integer
---@field vehicle integer
---@field radius number

local HELI_FOLLOW_ENTITY_NODE_TYPE = "core.heli_follow_entity"

---@type LDNodeEditorNodeType
local heliFollowEntityNode = {
    typeName = HELI_FOLLOW_ENTITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorHeliFollowEntityNode
        local newNode = {
            id = newNodeId,
            nodeType = HELI_FOLLOW_ENTITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorHeliFollowEntityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		HeliOp.followEntity(self_, char, vehicle, radius)
        return {1}
    end
}

return heliFollowEntityNode
