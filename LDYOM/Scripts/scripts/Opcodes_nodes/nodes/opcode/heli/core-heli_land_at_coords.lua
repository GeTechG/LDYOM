...
---@class LDNodeEditorHeliLandAtCoordsNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local HELI_LAND_AT_COORDS_NODE_TYPE = "core.heli_land_at_coords"

---@type LDNodeEditorNodeType
local heliLandAtCoordsNode = {
    typeName = HELI_LAND_AT_COORDS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorHeliLandAtCoordsNode
        local newNode = {
            id = newNodeId,
            nodeType = HELI_LAND_AT_COORDS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorHeliLandAtCoordsNode
    ...
    run = function(editor, node, inputValues)
		...
		HeliOp.landAtCoords(self_, x, y, z, minAltitude, maxAltitude)
        return {1}
    end
}

return heliLandAtCoordsNode
