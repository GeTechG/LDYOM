...
---@class LDNodeEditorWeatherForceNode : LDNodeEditorNode
---@field type integer

local WEATHER_FORCE_NODE_TYPE = "core.weather_force"

---@type LDNodeEditorNodeType
local weatherForceNode = {
    typeName = WEATHER_FORCE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorWeatherForceNode
        local newNode = {
            id = newNodeId,
            nodeType = WEATHER_FORCE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorWeatherForceNode
    ...
    run = function(editor, context, node, inputValues)
		...
		WeatherOp.force(type)
        return {1}
    end
}

return weatherForceNode
