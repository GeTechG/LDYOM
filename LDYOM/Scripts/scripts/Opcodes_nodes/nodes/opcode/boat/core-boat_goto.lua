...
---@class LDNodeEditorBoatGotoNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local BOAT_GOTO_NODE_TYPE = "core.boat_goto"

---@type LDNodeEditorNodeType
local boatGotoNode = {
    typeName = BOAT_GOTO_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorBoatGotoNode
        local newNode = {
            id = newNodeId,
            nodeType = BOAT_GOTO_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorBoatGotoNode
