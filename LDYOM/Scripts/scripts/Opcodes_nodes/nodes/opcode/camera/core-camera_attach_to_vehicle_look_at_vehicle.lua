...
---@class LDNodeEditorCameraAttachToVehicleLookAtVehicleNode : LDNodeEditorNode
...
local CAMERA_ATTACH_TO_VEHICLE_LOOK_AT_VEHICLE_NODE_TYPE = "core.camera_attach_to_vehicle_look_at_vehicle"

---@type LDNodeEditorNodeType
local cameraAttachToVehicleLookAtVehicleNode = {
    typeName = CAMERA_ATTACH_TO_VEHICLE_LOOK_AT_VEHICLE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCameraAttachToVehicleLookAtVehicleNode
        local newNode = {
            id = newNodeId,
            nodeType = CAMERA_ATTACH_TO_VEHICLE_LOOK_AT_VEHICLE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCameraAttachToVehicleLookAtVehicleNode
    ...
    run = function(editor, node, inputValues)
		...
		CameraOp.attachToVehicleLookAtVehicle(handle, xOffset, yOffset, zOffset, vehicle, tilt, switchStyle)
        return {1}
    end
}

return cameraAttachToVehicleLookAtVehicleNode
