...
---@class LDNodeEditorCameraSetVectorTrackNode : LDNodeEditorNode
---@field fromX number
---@field fromY number
---@field fromZ number
---@field toX number
...
local CAMERA_SET_VECTOR_TRACK_NODE_TYPE = "core.camera_set_vector_track"

---@type LDNodeEditorNodeType
local cameraSetVectorTrackNode = {
    typeName = CAMERA_SET_VECTOR_TRACK_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCameraSetVectorTrackNode
        local newNode = {
            id = newNodeId,
            nodeType = CAMERA_SET_VECTOR_TRACK_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCameraSetVectorTrackNode
...
return cameraSetVectorTrackNode
