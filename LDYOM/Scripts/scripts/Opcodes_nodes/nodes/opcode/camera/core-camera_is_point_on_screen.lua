...
---@class LDNodeEditorCameraIsPointOnScreenNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field radius number

local CAMERA_IS_POINT_ON_SCREEN_NODE_TYPE = "core.camera_is_point_on_screen"

---@type LDNodeEditorNodeType
local cameraIsPointOnScreenNode = {
    typeName = CAMERA_IS_POINT_ON_SCREEN_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCameraIsPointOnScreenNode
        local newNode = {
            id = newNodeId,
            nodeType = CAMERA_IS_POINT_ON_SCREEN_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCameraIsPointOnScreenNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = CameraOp.isPointOnScreen(x, y, z, radius)
        return {1, result}
    end
}

return cameraIsPointOnScreenNode
