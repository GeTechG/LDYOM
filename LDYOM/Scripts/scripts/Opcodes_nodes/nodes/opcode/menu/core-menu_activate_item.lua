...
---@class LDNodeEditorMenuActivateItemNode : LDNodeEditorNode
---@field self_ integer
---@field row integer
---@field state boolean

local MENU_ACTIVATE_ITEM_NODE_TYPE = "core.menu_activate_item"

---@type LDNodeEditorNodeType
local menuActivateItemNode = {
    typeName = MENU_ACTIVATE_ITEM_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMenuActivateItemNode
        local newNode = {
            id = newNodeId,
            nodeType = MENU_ACTIVATE_ITEM_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorMenuActivateItemNode
