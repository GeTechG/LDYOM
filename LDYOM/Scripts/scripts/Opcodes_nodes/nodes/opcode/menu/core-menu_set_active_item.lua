...
---@class LDNodeEditorMenuSetActiveItemNode : LDNodeEditorNode
---@field self_ integer
---@field row integer

local MENU_SET_ACTIVE_ITEM_NODE_TYPE = "core.menu_set_active_item"

---@type LDNodeEditorNodeType
local menuSetActiveItemNode = {
    typeName = MENU_SET_ACTIVE_ITEM_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMenuSetActiveItemNode
        local newNode = {
            id = newNodeId,
            nodeType = MENU_SET_ACTIVE_ITEM_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
