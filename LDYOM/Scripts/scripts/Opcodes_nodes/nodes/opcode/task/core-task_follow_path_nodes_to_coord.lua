...
---@class LDNodeEditorTaskFollowPathNodesToCoordNode : LDNodeEditorNode
...
local TASK_FOLLOW_PATH_NODES_TO_COORD_NODE_TYPE = "core.task_follow_path_nodes_to_coord"

---@type LDNodeEditorNodeType
local taskFollowPathNodesToCoordNode = {
    typeName = TASK_FOLLOW_PATH_NODES_TO_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskFollowPathNodesToCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_FOLLOW_PATH_NODES_TO_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return taskFollowPathNodesToCoordNode
