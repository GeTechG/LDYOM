...
---@class LDNodeEditorTaskSwimToCoordNode : LDNodeEditorNode
---@field handle integer
---@field x number
---@field y number
---@field z number

local TASK_SWIM_TO_COORD_NODE_TYPE = "core.task_swim_to_coord"

---@type LDNodeEditorNodeType
local taskSwimToCoordNode = {
    typeName = TASK_SWIM_TO_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskSwimToCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SWIM_TO_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskSwimToCoordNode
    ...
    run = function(editor, context, node, inputValues)
		...
		TaskOp.swimToCoord(handle, x, y, z)
        return {1}
    end
}

return taskSwimToCoordNode
