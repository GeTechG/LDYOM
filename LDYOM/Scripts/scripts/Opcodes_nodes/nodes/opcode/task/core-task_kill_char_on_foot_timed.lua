...
---@class LDNodeEditorTaskKillCharOnFootTimedNode : LDNodeEditorNode
---@field handle integer
---@field target integer
---@field time integer

local TASK_KILL_CHAR_ON_FOOT_TIMED_NODE_TYPE = "core.task_kill_char_on_foot_timed"

---@type LDNodeEditorNodeType
local taskKillCharOnFootTimedNode = {
    typeName = TASK_KILL_CHAR_ON_FOOT_TIMED_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskKillCharOnFootTimedNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_KILL_CHAR_ON_FOOT_TIMED_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskKillCharOnFootTimedNode
...
return taskKillCharOnFootTimedNode
