...
---@class LDNodeEditorTaskTurnCharToFaceCoordNode : LDNodeEditorNode
---@field handle integer
---@field x number
---@field y number
---@field z number

local TASK_TURN_CHAR_TO_FACE_COORD_NODE_TYPE = "core.task_turn_char_to_face_coord"

---@type LDNodeEditorNodeType
local taskTurnCharToFaceCoordNode = {
    typeName = TASK_TURN_CHAR_TO_FACE_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskTurnCharToFaceCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_TURN_CHAR_TO_FACE_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskTurnCharToFaceCoordNode
    ...
    run = function(editor, node, inputValues)
		...
		TaskOp.turnCharToFaceCoord(handle, x, y, z)
        return {1}
    end
}

return taskTurnCharToFaceCoordNode
