...
---@class LDNodeEditorTaskDestroyCarNode : LDNodeEditorNode
---@field char integer
---@field vehicle integer

local TASK_DESTROY_CAR_NODE_TYPE = "core.task_destroy_car"

---@type LDNodeEditorNodeType
local taskDestroyCarNode = {
    typeName = TASK_DESTROY_CAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskDestroyCarNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_DESTROY_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskDestroyCarNode
    ...
    run = function(editor, context, node, inputValues)
		...
		TaskOp.destroyCar(char, vehicle)
        return {1}
    end
}

return taskDestroyCarNode
