...
---@class LDNodeEditorTaskGoToObjectNode : LDNodeEditorNode
---@field char integer
---@field object integer
---@field time integer
---@field radius number

local TASK_GO_TO_OBJECT_NODE_TYPE = "core.task_go_to_object"

---@type LDNodeEditorNodeType
local taskGoToObjectNode = {
    typeName = TASK_GO_TO_OBJECT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskGoToObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_GO_TO_OBJECT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskGoToObjectNode
