...
---@class LDNodeEditorTaskGotoCarNode : LDNodeEditorNode
---@field char integer
---@field vehicle integer
---@field time integer
---@field radius number

local TASK_GOTO_CAR_NODE_TYPE = "core.task_goto_car"

---@type LDNodeEditorNodeType
local taskGotoCarNode = {
    typeName = TASK_GOTO_CAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskGotoCarNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_GOTO_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskGotoCarNode
