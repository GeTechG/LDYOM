...
---@class LDNodeEditorTaskFleePointNode : LDNodeEditorNode
...
local TASK_FLEE_POINT_NODE_TYPE = "core.task_flee_point"

---@type LDNodeEditorNodeType
local taskFleePointNode = {
    typeName = TASK_FLEE_POINT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskFleePointNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_FLEE_POINT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskFleePointNode
