...
---@class LDNodeEditorTaskDrivePointRouteNode : LDNodeEditorNode
---@field char integer
---@field vehicle integer
---@field speed integer

local TASK_DRIVE_POINT_ROUTE_NODE_TYPE = "core.task_drive_point_route"

---@type LDNodeEditorNodeType
local taskDrivePointRouteNode = {
    typeName = TASK_DRIVE_POINT_ROUTE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskDrivePointRouteNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_DRIVE_POINT_ROUTE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskDrivePointRouteNode
...
return taskDrivePointRouteNode
