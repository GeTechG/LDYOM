...
---@class LDNodeEditorTaskAimGunAtCharNode : LDNodeEditorNode
---@field char integer
---@field target integer
---@field time integer

local TASK_AIM_GUN_AT_CHAR_NODE_TYPE = "core.task_aim_gun_at_char"

---@type LDNodeEditorNodeType
local taskAimGunAtCharNode = {
    typeName = TASK_AIM_GUN_AT_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskAimGunAtCharNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_AIM_GUN_AT_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
