...
---@class LDNodeEditorTaskShootAtCoordNode : LDNodeEditorNode
...
local TASK_SHOOT_AT_COORD_NODE_TYPE = "core.task_shoot_at_coord"

---@type LDNodeEditorNodeType
local taskShootAtCoordNode = {
    typeName = TASK_SHOOT_AT_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskShootAtCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SHOOT_AT_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
