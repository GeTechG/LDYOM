...
---@class LDNodeEditorTaskSitDownNode : LDNodeEditorNode
---@field handle integer
---@field time integer

local TASK_SIT_DOWN_NODE_TYPE = "core.task_sit_down"

---@type LDNodeEditorNodeType
local taskSitDownNode = {
    typeName = TASK_SIT_DOWN_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskSitDownNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SIT_DOWN_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskSitDownNode
