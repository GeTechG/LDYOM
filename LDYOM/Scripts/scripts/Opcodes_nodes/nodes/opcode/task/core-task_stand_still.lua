...
---@class LDNodeEditorTaskStandStillNode : LDNodeEditorNode
---@field handle integer
---@field time integer

local TASK_STAND_STILL_NODE_TYPE = "core.task_stand_still"

---@type LDNodeEditorNodeType
local taskStandStillNode = {
    typeName = TASK_STAND_STILL_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskStandStillNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_STAND_STILL_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
