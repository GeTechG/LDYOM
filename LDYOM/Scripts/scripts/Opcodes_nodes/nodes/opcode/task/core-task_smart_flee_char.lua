...
---@class LDNodeEditorTaskSmartFleeCharNode : LDNodeEditorNode
---@field handle integer
---@field threat integer
---@field radius number
---@field time integer

local TASK_SMART_FLEE_CHAR_NODE_TYPE = "core.task_smart_flee_char"

---@type LDNodeEditorNodeType
local taskSmartFleeCharNode = {
    typeName = TASK_SMART_FLEE_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskSmartFleeCharNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SMART_FLEE_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskSmartFleeCharNode
