...
---@class LDNodeEditorTaskShuffleToNextCarSeatNode : LDNodeEditorNode
---@field char integer
---@field vehicle integer

local TASK_SHUFFLE_TO_NEXT_CAR_SEAT_NODE_TYPE = "core.task_shuffle_to_next_car_seat"

---@type LDNodeEditorNodeType
local taskShuffleToNextCarSeatNode = {
    typeName = TASK_SHUFFLE_TO_NEXT_CAR_SEAT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskShuffleToNextCarSeatNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SHUFFLE_TO_NEXT_CAR_SEAT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskShuffleToNextCarSeatNode
    ...
    run = function(editor, node, inputValues)
		...
		TaskOp.shuffleToNextCarSeat(char, vehicle)
        return {1}
    end
}

return taskShuffleToNextCarSeatNode
