...
---@class LDNodeEditorTaskTurnCharToFaceCharNode : LDNodeEditorNode
---@field char integer
---@field target integer

local TASK_TURN_CHAR_TO_FACE_CHAR_NODE_TYPE = "core.task_turn_char_to_face_char"

---@type LDNodeEditorNodeType
local taskTurnCharToFaceCharNode = {
    typeName = TASK_TURN_CHAR_TO_FACE_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskTurnCharToFaceCharNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_TURN_CHAR_TO_FACE_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return taskTurnCharToFaceCharNode
