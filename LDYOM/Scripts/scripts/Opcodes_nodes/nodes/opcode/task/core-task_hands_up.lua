...
---@class LDNodeEditorTaskHandsUpNode : LDNodeEditorNode
---@field handle integer
---@field time integer

local TASK_HANDS_UP_NODE_TYPE = "core.task_hands_up"

---@type LDNodeEditorNodeType
local taskHandsUpNode = {
    typeName = TASK_HANDS_UP_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskHandsUpNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_HANDS_UP_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskHandsUpNode
