...
---@class LDNodeEditorTaskLookAtCoordNode : LDNodeEditorNode
...
local TASK_LOOK_AT_COORD_NODE_TYPE = "core.task_look_at_coord"

---@type LDNodeEditorNodeType
local taskLookAtCoordNode = {
    typeName = TASK_LOOK_AT_COORD_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskLookAtCoordNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_LOOK_AT_COORD_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskLookAtCoordNode
