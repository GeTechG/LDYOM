...
---@class LDNodeEditorTaskDuckNode : LDNodeEditorNode
---@field handle integer
---@field time integer

local TASK_DUCK_NODE_TYPE = "core.task_duck"

---@type LDNodeEditorNodeType
local taskDuckNode = {
    typeName = TASK_DUCK_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskDuckNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_DUCK_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTaskDuckNode
