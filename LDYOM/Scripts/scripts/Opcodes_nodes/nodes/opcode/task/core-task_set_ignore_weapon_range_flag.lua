...
---@class LDNodeEditorTaskSetIgnoreWeaponRangeFlagNode : LDNodeEditorNode
---@field handle integer
---@field state boolean

local TASK_SET_IGNORE_WEAPON_RANGE_FLAG_NODE_TYPE = "core.task_set_ignore_weapon_range_flag"

---@type LDNodeEditorNodeType
local taskSetIgnoreWeaponRangeFlagNode = {
    typeName = TASK_SET_IGNORE_WEAPON_RANGE_FLAG_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTaskSetIgnoreWeaponRangeFlagNode
        local newNode = {
            id = newNodeId,
            nodeType = TASK_SET_IGNORE_WEAPON_RANGE_FLAG_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return taskSetIgnoreWeaponRangeFlagNode
