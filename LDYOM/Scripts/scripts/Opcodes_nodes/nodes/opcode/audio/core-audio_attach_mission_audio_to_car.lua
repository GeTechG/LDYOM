...
---@class LDNodeEditorAudioAttachMissionAudioToCarNode : LDNodeEditorNode
---@field slotId integer
---@field handle integer

local AUDIO_ATTACH_MISSION_AUDIO_TO_CAR_NODE_TYPE = "core.audio_attach_mission_audio_to_car"

---@type LDNodeEditorNodeType
local audioAttachMissionAudioToCarNode = {
    typeName = AUDIO_ATTACH_MISSION_AUDIO_TO_CAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorAudioAttachMissionAudioToCarNode
        local newNode = {
            id = newNodeId,
            nodeType = AUDIO_ATTACH_MISSION_AUDIO_TO_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return audioAttachMissionAudioToCarNode
