...
---@class LDNodeEditorAudioClearMissionAudioNode : LDNodeEditorNode
---@field slotId integer

local AUDIO_CLEAR_MISSION_AUDIO_NODE_TYPE = "core.audio_clear_mission_audio"

---@type LDNodeEditorNodeType
local audioClearMissionAudioNode = {
    typeName = AUDIO_CLEAR_MISSION_AUDIO_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorAudioClearMissionAudioNode
        local newNode = {
            id = newNodeId,
            nodeType = AUDIO_CLEAR_MISSION_AUDIO_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return audioClearMissionAudioNode
