...
---@class LDNodeEditorAudioAttachMissionAudioToCharNode : LDNodeEditorNode
---@field slotId integer
---@field handle integer

local AUDIO_ATTACH_MISSION_AUDIO_TO_CHAR_NODE_TYPE = "core.audio_attach_mission_audio_to_char"

---@type LDNodeEditorNodeType
local audioAttachMissionAudioToCharNode = {
    typeName = AUDIO_ATTACH_MISSION_AUDIO_TO_CHAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorAudioAttachMissionAudioToCharNode
        local newNode = {
            id = newNodeId,
            nodeType = AUDIO_ATTACH_MISSION_AUDIO_TO_CHAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return audioAttachMissionAudioToCharNode
