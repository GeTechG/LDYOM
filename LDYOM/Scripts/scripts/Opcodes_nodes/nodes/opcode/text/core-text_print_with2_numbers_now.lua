...
---@class LDNodeEditorTextPrintWith2NumbersNowNode : LDNodeEditorNode
---@field key string
---@field num1 integer
---@field num2 integer
...
local TEXT_PRINT_WITH2_NUMBERS_NOW_NODE_TYPE = "core.text_print_with2_numbers_now"

---@type LDNodeEditorNodeType
local textPrintWith2NumbersNowNode = {
    typeName = TEXT_PRINT_WITH2_NUMBERS_NOW_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintWith2NumbersNowNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_WITH2_NUMBERS_NOW_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTextPrintWith2NumbersNowNode
...
return textPrintWith2NumbersNowNode
