...
---@class LDNodeEditorTextPrintFormattedNode : LDNodeEditorNode
---@field fmt string
---@field time integer
---@field arg integer

local TEXT_PRINT_FORMATTED_NODE_TYPE = "core.text_print_formatted"

---@type LDNodeEditorNodeType
local textPrintFormattedNode = {
    typeName = TEXT_PRINT_FORMATTED_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintFormattedNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_FORMATTED_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
