...
---@class LDNodeEditorTextPrintBigQNode : LDNodeEditorNode
---@field key string
---@field duration integer
---@field style integer

local TEXT_PRINT_BIG_Q_NODE_TYPE = "core.text_print_big_q"

---@type LDNodeEditorNodeType
local textPrintBigQNode = {
    typeName = TEXT_PRINT_BIG_Q_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintBigQNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_BIG_Q_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
