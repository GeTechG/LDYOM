...
---@class LDNodeEditorTextPrintWith4NumbersNowNode : LDNodeEditorNode
---@field key string
---@field num1 integer
---@field num2 integer
---@field num3 integer
...
local TEXT_PRINT_WITH4_NUMBERS_NOW_NODE_TYPE = "core.text_print_with4_numbers_now"

---@type LDNodeEditorNodeType
local textPrintWith4NumbersNowNode = {
    typeName = TEXT_PRINT_WITH4_NUMBERS_NOW_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintWith4NumbersNowNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_WITH4_NUMBERS_NOW_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorTextPrintWith4NumbersNowNode
    ...
    run = function(editor, context, node, inputValues)
		...
		TextOp.printWith4NumbersNow(key, math.floor(num1), math.floor(num2), math.floor(num3), math.floor(num4), math.floor(duration), style)
        return {1}
    end
}

return textPrintWith4NumbersNowNode
