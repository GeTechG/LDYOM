...
---@class LDNodeEditorTextPrintWithNumberNode : LDNodeEditorNode
---@field key string
---@field num integer
---@field duration integer
---@field flag integer

local TEXT_PRINT_WITH_NUMBER_NODE_TYPE = "core.text_print_with_number"

---@type LDNodeEditorNodeType
local textPrintWithNumberNode = {
    typeName = TEXT_PRINT_WITH_NUMBER_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextPrintWithNumberNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_PRINT_WITH_NUMBER_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return textPrintWithNumberNode
