...
---@class LDNodeEditorTextStringFloatFormatNode : LDNodeEditorNode
---@field number number
---@field format string

local TEXT_STRING_FLOAT_FORMAT_NODE_TYPE = "core.text_string_float_format"

---@type LDNodeEditorNodeType
local textStringFloatFormatNode = {
    typeName = TEXT_STRING_FLOAT_FORMAT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorTextStringFloatFormatNode
        local newNode = {
            id = newNodeId,
            nodeType = TEXT_STRING_FLOAT_FORMAT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return textStringFloatFormatNode
