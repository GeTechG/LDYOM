...
---@class LDNodeEditorObjectIsInArea3DNode : LDNodeEditorNode
---@field self_ integer
...
local OBJECT_IS_IN_AREA3_D_NODE_TYPE = "core.object_is_in_area3_d"

---@type LDNodeEditorNodeType
local objectIsInArea3DNode = {
    typeName = OBJECT_IS_IN_AREA3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectIsInArea3DNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_IS_IN_AREA3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectIsInArea3DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = ObjectOp.isInArea3D(self_, leftBottomX, leftBottomY, leftBottomZ, rightTopX, rightTopY, rightTopZ, drawSphere)
        return {result}
    end
}

return objectIsInArea3DNode
