...
---@class LDNodeEditorObjectIsInArea2DNode : LDNodeEditorNode
---@field self_ integer
...
local OBJECT_IS_IN_AREA2_D_NODE_TYPE = "core.object_is_in_area2_d"

---@type LDNodeEditorNodeType
local objectIsInArea2DNode = {
    typeName = OBJECT_IS_IN_AREA2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectIsInArea2DNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_IS_IN_AREA2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectIsInArea2DNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local result = ObjectOp.isInArea2D(self_, leftBottomX, leftBottomY, rightTopX, rightTopY, drawSphere)
        return {result}
    end
}

return objectIsInArea2DNode
