...
---@class LDNodeEditorObjectAddVelocityRelativeNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_ADD_VELOCITY_RELATIVE_NODE_TYPE = "core.object_add_velocity_relative"

---@type LDNodeEditorNodeType
local objectAddVelocityRelativeNode = {
    typeName = OBJECT_ADD_VELOCITY_RELATIVE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectAddVelocityRelativeNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_ADD_VELOCITY_RELATIVE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectAddVelocityRelativeNode
    ...
    run = function(editor, node, inputValues)
		...
		ObjectOp.addVelocityRelative(self_, x, y, z)
        return {1}
    end
}

return objectAddVelocityRelativeNode
