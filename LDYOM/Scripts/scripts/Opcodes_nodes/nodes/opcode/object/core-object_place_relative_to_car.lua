...
---@class LDNodeEditorObjectPlaceRelativeToCarNode : LDNodeEditorNode
---@field self_ integer
...
local OBJECT_PLACE_RELATIVE_TO_CAR_NODE_TYPE = "core.object_place_relative_to_car"

---@type LDNodeEditorNodeType
local objectPlaceRelativeToCarNode = {
    typeName = OBJECT_PLACE_RELATIVE_TO_CAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectPlaceRelativeToCarNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_PLACE_RELATIVE_TO_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectPlaceRelativeToCarNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.placeRelativeToCar(self_, vehicle, xOffset, yOffset, zOffset)
        return {1}
    end
}

return objectPlaceRelativeToCarNode
