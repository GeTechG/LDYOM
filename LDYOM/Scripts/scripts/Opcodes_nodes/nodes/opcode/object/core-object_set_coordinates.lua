...
---@class LDNodeEditorObjectSetCoordinatesNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_SET_COORDINATES_NODE_TYPE = "core.object_set_coordinates"

---@type LDNodeEditorNodeType
local objectSetCoordinatesNode = {
    typeName = OBJECT_SET_COORDINATES_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectSetCoordinatesNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_SET_COORDINATES_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectSetCoordinatesNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.setCoordinates(self_, x, y, z)
        return {1}
    end
}

return objectSetCoordinatesNode
