...
---@class LDNodeEditorObjectSetQuaternionNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number
...
local OBJECT_SET_QUATERNION_NODE_TYPE = "core.object_set_quaternion"

---@type LDNodeEditorNodeType
local objectSetQuaternionNode = {
    typeName = OBJECT_SET_QUATERNION_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectSetQuaternionNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_SET_QUATERNION_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectSetQuaternionNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.setQuaternion(self_, x, y, z, w)
        return {1}
    end
}

return objectSetQuaternionNode
