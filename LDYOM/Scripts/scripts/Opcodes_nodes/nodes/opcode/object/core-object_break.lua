...
---@class LDNodeEditorObjectBreakNode : LDNodeEditorNode
---@field self_ integer
---@field intensity integer

local OBJECT_BREAK_NODE_TYPE = "core.object_break"

---@type LDNodeEditorNodeType
local objectBreakNode = {
    typeName = OBJECT_BREAK_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectBreakNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_BREAK_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectBreakNode
