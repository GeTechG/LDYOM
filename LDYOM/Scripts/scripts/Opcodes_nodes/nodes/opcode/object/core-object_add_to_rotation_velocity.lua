...
---@class LDNodeEditorObjectAddToRotationVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_ADD_TO_ROTATION_VELOCITY_NODE_TYPE = "core.object_add_to_rotation_velocity"

---@type LDNodeEditorNodeType
local objectAddToRotationVelocityNode = {
    typeName = OBJECT_ADD_TO_ROTATION_VELOCITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectAddToRotationVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_ADD_TO_ROTATION_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectAddToRotationVelocityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.addToRotationVelocity(self_, x, y, z)
        return {1}
    end
}

return objectAddToRotationVelocityNode
