...
---@class LDNodeEditorObjectSetRotationNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_SET_ROTATION_NODE_TYPE = "core.object_set_rotation"

---@type LDNodeEditorNodeType
local objectSetRotationNode = {
    typeName = OBJECT_SET_ROTATION_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectSetRotationNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_SET_ROTATION_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectSetRotationNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.setRotation(self_, x, y, z)
        return {1}
    end
}

return objectSetRotationNode
