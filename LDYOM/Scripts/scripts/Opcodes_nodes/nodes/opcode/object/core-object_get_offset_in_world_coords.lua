...
---@class LDNodeEditorObjectGetOffsetInWorldCoordsNode : LDNodeEditorNode
---@field self_ integer
---@field xOffset number
---@field yOffset number
---@field zOffset number

local OBJECT_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE = "core.object_get_offset_in_world_coords"

---@type LDNodeEditorNodeType
local objectGetOffsetInWorldCoordsNode = {
    typeName = OBJECT_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectGetOffsetInWorldCoordsNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_GET_OFFSET_IN_WORLD_COORDS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectGetOffsetInWorldCoordsNode
    ...
    run = function(editor, context, node, inputValues)
		...
		local x, y, z = ObjectOp.getOffsetInWorldCoords(self_, xOffset, yOffset, zOffset)
        return {1, x, y, z}
    end
}

return objectGetOffsetInWorldCoordsNode
