...
---@class LDNodeEditorObjectSetRotationVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_SET_ROTATION_VELOCITY_NODE_TYPE = "core.object_set_rotation_velocity"

---@type LDNodeEditorNodeType
local objectSetRotationVelocityNode = {
    typeName = OBJECT_SET_ROTATION_VELOCITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectSetRotationVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_SET_ROTATION_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectSetRotationVelocityNode
    ...
    run = function(editor, node, inputValues)
		...
		ObjectOp.setRotationVelocity(self_, x, y, z)
        return {1}
    end
}

return objectSetRotationVelocityNode
