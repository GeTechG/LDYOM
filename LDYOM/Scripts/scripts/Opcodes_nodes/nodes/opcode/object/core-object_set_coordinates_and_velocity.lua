...
---@class LDNodeEditorObjectSetCoordinatesAndVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_SET_COORDINATES_AND_VELOCITY_NODE_TYPE = "core.object_set_coordinates_and_velocity"

---@type LDNodeEditorNodeType
local objectSetCoordinatesAndVelocityNode = {
    typeName = OBJECT_SET_COORDINATES_AND_VELOCITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectSetCoordinatesAndVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_SET_COORDINATES_AND_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectSetCoordinatesAndVelocityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.setCoordinatesAndVelocity(self_, x, y, z)
        return {1}
    end
}

return objectSetCoordinatesAndVelocityNode
