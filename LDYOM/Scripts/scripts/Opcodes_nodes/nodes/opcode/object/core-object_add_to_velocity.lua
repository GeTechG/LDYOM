...
---@class LDNodeEditorObjectAddToVelocityNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local OBJECT_ADD_TO_VELOCITY_NODE_TYPE = "core.object_add_to_velocity"

---@type LDNodeEditorNodeType
local objectAddToVelocityNode = {
    typeName = OBJECT_ADD_TO_VELOCITY_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectAddToVelocityNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_ADD_TO_VELOCITY_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectAddToVelocityNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.addToVelocity(self_, x, y, z)
        return {1}
    end
}

return objectAddToVelocityNode
