...
---@class LDNodeEditorObjectAttachToCarNode : LDNodeEditorNode
---@field self_ integer
...
local OBJECT_ATTACH_TO_CAR_NODE_TYPE = "core.object_attach_to_car"

---@type LDNodeEditorNodeType
local objectAttachToCarNode = {
    typeName = OBJECT_ATTACH_TO_CAR_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorObjectAttachToCarNode
        local newNode = {
            id = newNodeId,
            nodeType = OBJECT_ATTACH_TO_CAR_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorObjectAttachToCarNode
    ...
    run = function(editor, context, node, inputValues)
		...
		ObjectOp.attachToCar(self_, handle, xOffset, yOffset, zOffset, xRotation, yRotation, zRotation)
        return {1}
    end
}

return objectAttachToCarNode
