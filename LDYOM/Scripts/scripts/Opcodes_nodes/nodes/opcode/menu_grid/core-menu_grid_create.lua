...
---@class LDNodeEditorMenuGridCreateNode : LDNodeEditorNode
---@field header string
...
local MENU_GRID_CREATE_NODE_TYPE = "core.menu_grid_create"

---@type LDNodeEditorNodeType
local menuGridCreateNode = {
    typeName = MENU_GRID_CREATE_NODE_TYPE,
    category = "opcode.menu_grid",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMenuGridCreateNode
        local newNode = {
            id = newNodeId,
            nodeType = MENU_GRID_CREATE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorMenuGridCreateNode
