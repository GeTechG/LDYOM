...
---@class LDNodeEditorGameClearRelationshipNode : LDNodeEditorNode
---@field relationshipType integer
---@field ofPedType integer
---@field toPedType integer

local GAME_CLEAR_RELATIONSHIP_NODE_TYPE = "core.game_clear_relationship"

---@type LDNodeEditorNodeType
local gameClearRelationshipNode = {
    typeName = GAME_CLEAR_RELATIONSHIP_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorGameClearRelationshipNode
        local newNode = {
            id = newNodeId,
            nodeType = GAME_CLEAR_RELATIONSHIP_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorGameClearRelationshipNode
    ...
    run = function(editor, node, inputValues)
		...
		GameOp.clearRelationship(relationshipType, ofPedType, toPedType)
        return {1}
    end
}

return gameClearRelationshipNode
