...
---@class LDNodeEditorGameSetEveryoneIgnorePlayerNode : LDNodeEditorNode
---@field player integer
---@field state boolean

local GAME_SET_EVERYONE_IGNORE_PLAYER_NODE_TYPE = "core.game_set_everyone_ignore_player"

---@type LDNodeEditorNodeType
local gameSetEveryoneIgnorePlayerNode = {
    typeName = GAME_SET_EVERYONE_IGNORE_PLAYER_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorGameSetEveryoneIgnorePlayerNode
        local newNode = {
            id = newNodeId,
            nodeType = GAME_SET_EVERYONE_IGNORE_PLAYER_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return gameSetEveryoneIgnorePlayerNode
