...
---@class LDNodeEditorStreamingLoadSceneNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number

local STREAMING_LOAD_SCENE_NODE_TYPE = "core.streaming_load_scene"

---@type LDNodeEditorNodeType
local streamingLoadSceneNode = {
    typeName = STREAMING_LOAD_SCENE_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorStreamingLoadSceneNode
        local newNode = {
            id = newNodeId,
            nodeType = STREAMING_LOAD_SCENE_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorStreamingLoadSceneNode
    ...
    run = function(editor, context, node, inputValues)
		...
		StreamingOp.loadScene(x, y, z)
        return {1}
    end
}

return streamingLoadSceneNode
