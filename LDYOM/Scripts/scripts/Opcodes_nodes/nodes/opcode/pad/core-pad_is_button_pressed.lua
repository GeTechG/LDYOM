...
---@class LDNodeEditorPadIsButtonPressedNode : LDNodeEditorNode
---@field pad integer
---@field buttonId integer

local PAD_IS_BUTTON_PRESSED_NODE_TYPE = "core.pad_is_button_pressed"

---@type LDNodeEditorNodeType
local padIsButtonPressedNode = {
    typeName = PAD_IS_BUTTON_PRESSED_NODE_TYPE,
    category = "opcode.pad",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorPadIsButtonPressedNode
        local newNode = {
            id = newNodeId,
