...
---@class LDNodeEditorPadSetPlayerJumpButtonNode : LDNodeEditorNode
---@field playerId integer
---@field state boolean

local PAD_SET_PLAYER_JUMP_BUTTON_NODE_TYPE = "core.pad_set_player_jump_button"

---@type LDNodeEditorNodeType
local padSetPlayerJumpButtonNode = {
    typeName = PAD_SET_PLAYER_JUMP_BUTTON_NODE_TYPE,
    category = "opcode.pad",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorPadSetPlayerJumpButtonNode
        local newNode = {
            id = newNodeId,
            nodeType = PAD_SET_PLAYER_JUMP_BUTTON_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorPadSetPlayerJumpButtonNode
    ...
    run = function(editor, context, node, inputValues)
		...
		PadOp.setPlayerJumpButton(playerId, state)
        return {1}
    end
}

return padSetPlayerJumpButtonNode
