...
---@class LDNodeEditorCheckpointSetCoordsNode : LDNodeEditorNode
---@field self_ integer
---@field x number
---@field y number
---@field z number

local CHECKPOINT_SET_COORDS_NODE_TYPE = "core.checkpoint_set_coords"

---@type LDNodeEditorNodeType
local checkpointSetCoordsNode = {
    typeName = CHECKPOINT_SET_COORDS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorCheckpointSetCoordsNode
        local newNode = {
            id = newNodeId,
            nodeType = CHECKPOINT_SET_COORDS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorCheckpointSetCoordsNode
    ...
    run = function(editor, context, node, inputValues)
		...
		CheckpointOp.setCoords(self_, x, y, z)
        return {1}
    end
}

return checkpointSetCoordsNode
