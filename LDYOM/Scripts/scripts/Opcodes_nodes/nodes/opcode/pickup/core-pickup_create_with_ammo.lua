...
---@class LDNodeEditorPickupCreateWithAmmoNode : LDNodeEditorNode
...
local PICKUP_CREATE_WITH_AMMO_NODE_TYPE = "core.pickup_create_with_ammo"

---@type LDNodeEditorNodeType
local pickupCreateWithAmmoNode = {
    typeName = PICKUP_CREATE_WITH_AMMO_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorPickupCreateWithAmmoNode
        local newNode = {
            id = newNodeId,
            nodeType = PICKUP_CREATE_WITH_AMMO_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
...
return pickupCreateWithAmmoNode
