...
---@class LDNodeEditorFxAddExplosionNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field type integer

local FX_ADD_EXPLOSION_NODE_TYPE = "core.fx_add_explosion"

---@type LDNodeEditorNodeType
local fxAddExplosionNode = {
    typeName = FX_ADD_EXPLOSION_NODE_TYPE,
    category = "opcode.fx",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorFxAddExplosionNode
        local newNode = {
            id = newNodeId,
            nodeType = FX_ADD_EXPLOSION_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorFxAddExplosionNode
    ...
    run = function(editor, context, node, inputValues)
		...
		FxOp.addExplosion(x, y, z, type)
        return {1}
    end
}

return fxAddExplosionNode
