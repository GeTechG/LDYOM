...
---@class LDNodeEditorFxDrawCoronaNode : LDNodeEditorNode
---@field x number
---@field y number
---@field z number
---@field size number
...
local FX_DRAW_CORONA_NODE_TYPE = "core.fx_draw_corona"

---@type LDNodeEditorNodeType
local fxDrawCoronaNode = {
    typeName = FX_DRAW_CORONA_NODE_TYPE,
    category = "opcode.fx",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorFxDrawCoronaNode
        local newNode = {
            id = newNodeId,
            nodeType = FX_DRAW_CORONA_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorFxDrawCoronaNode
