...
---@class LDNodeEditorMathGetHeadingFromVector2DNode : LDNodeEditorNode
---@field x number
---@field y number

local MATH_GET_HEADING_FROM_VECTOR2_D_NODE_TYPE = "core.math_get_heading_from_vector2_d"

---@type LDNodeEditorNodeType
local mathGetHeadingFromVector2DNode = {
    typeName = MATH_GET_HEADING_FROM_VECTOR2_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMathGetHeadingFromVector2DNode
        local newNode = {
            id = newNodeId,
            nodeType = MATH_GET_HEADING_FROM_VECTOR2_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    draw = function(editor, ctx, node, builder)
		...
		LDNodeEditor.defaultOutput(editor, ctx, builder, node.outputs[2], "heading");
...
return mathGetHeadingFromVector2DNode
