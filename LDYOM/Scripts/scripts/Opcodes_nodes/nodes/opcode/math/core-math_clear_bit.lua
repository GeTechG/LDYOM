...
---@class LDNodeEditorMathClearBitNode : LDNodeEditorNode
---@field number integer
---@field n integer

local MATH_CLEAR_BIT_NODE_TYPE = "core.math_clear_bit"

---@type LDNodeEditorNodeType
local mathClearBitNode = {
    typeName = MATH_CLEAR_BIT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMathClearBitNode
        local newNode = {
            id = newNodeId,
            nodeType = MATH_CLEAR_BIT_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
