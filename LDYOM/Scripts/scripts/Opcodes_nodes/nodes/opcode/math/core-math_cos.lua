...
---@class LDNodeEditorMathCosNode : LDNodeEditorNode
---@field angle number

local MATH_COS_NODE_TYPE = "core.math_cos"

---@type LDNodeEditorNodeType
local mathCosNode = {
    typeName = MATH_COS_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMathCosNode
        local newNode = {
            id = newNodeId,
            nodeType = MATH_COS_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
