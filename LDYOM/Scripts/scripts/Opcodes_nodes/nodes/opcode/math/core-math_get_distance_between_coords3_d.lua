...
---@class LDNodeEditorMathGetDistanceBetweenCoords3DNode : LDNodeEditorNode
---@field fromX number
---@field fromY number
---@field fromZ number
---@field toX number
...
local MATH_GET_DISTANCE_BETWEEN_COORDS3_D_NODE_TYPE = "core.math_get_distance_between_coords3_d"

---@type LDNodeEditorNodeType
local mathGetDistanceBetweenCoords3DNode = {
    typeName = MATH_GET_DISTANCE_BETWEEN_COORDS3_D_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorMathGetDistanceBetweenCoords3DNode
        local newNode = {
            id = newNodeId,
            nodeType = MATH_GET_DISTANCE_BETWEEN_COORDS3_D_NODE_TYPE,
            inputs = {
                {
                    id = getPinId(),
                    node = newNodeId,
    ...
    run = function(editor, context, node, inputValues)
		...
		local distance = MathOp.getDistanceBetweenCoords3D(fromX, fromY, fromZ, toX, toY, toZ)
        return {1, distance}
    end
}

return mathGetDistanceBetweenCoords3DNode
