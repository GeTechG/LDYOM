...
---@class LDNodeEditorDestroyObjectNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local DESTROY_OBJECT_NODE_TYPE = "core.destroy_object"

---@type LDNodeEditorNodeType
local destroyObjectNode = {
    typeName = DESTROY_OBJECT_NODE_TYPE,
    category = "object",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorDestroyObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = DESTROY_OBJECT_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorDestroyObjectNode
