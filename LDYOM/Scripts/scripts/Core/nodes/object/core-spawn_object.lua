...
---@class LDNodeEditorSpawnObjectNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_OBJECT_NODE_TYPE = "core.spawn_object"

---@type LDNodeEditorNodeType
local spawnObjectNode = {
    typeName = SPAWN_OBJECT_NODE_TYPE,
    category = "object",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnObjectNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_OBJECT_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnObjectNode
