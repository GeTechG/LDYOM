...
---@class LDNodeEditorSpawnParticleNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_PARTICLE_NODE_TYPE = "core.spawn_particle"

---@type LDNodeEditorNodeType
local spawnParticleNode = {
    typeName = SPAWN_PARTICLE_NODE_TYPE,
    category = "particle",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnParticleNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_PARTICLE_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnParticleNode
