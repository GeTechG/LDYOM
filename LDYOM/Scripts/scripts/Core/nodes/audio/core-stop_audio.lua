...
---@class LDNodeEditorStopAudioNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local STOP_AUDIO_NODE_TYPE = "core.stop_audio"

---@type LDNodeEditorNodeType
local stopAudioNode = {
    typeName = STOP_AUDIO_NODE_TYPE,
    category = "audio",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorStopAudioNode
        local newNode = {
            id = newNodeId,
            nodeType = STOP_AUDIO_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorStopAudioNode
