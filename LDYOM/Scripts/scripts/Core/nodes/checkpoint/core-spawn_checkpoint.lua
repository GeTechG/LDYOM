...
---@class LDNodeEditorSpawnCheckpointNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_CHECKPOINT_NODE_TYPE = "core.spawn_checkpoint"

---@type LDNodeEditorNodeType
local spawnCheckpointNode = {
    typeName = SPAWN_CHECKPOINT_NODE_TYPE,
    category = "checkpoint",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnCheckpointNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_CHECKPOINT_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnCheckpointNode
