...
---@class LDNodeEditorDestroyPickupNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local DESTROY_PICKUP_NODE_TYPE = "core.destroy_pickup"

---@type LDNodeEditorNodeType
local destroyPickupNode = {
    typeName = DESTROY_PICKUP_NODE_TYPE,
    category = "pickup",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorDestroyPickupNode
        local newNode = {
            id = newNodeId,
            nodeType = DESTROY_PICKUP_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorDestroyPickupNode
