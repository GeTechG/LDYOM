...
---@class LDNodeEditorSpawnTrainNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_TRAIN_NODE_TYPE = "core.spawn_train"

---@type LDNodeEditorNodeType
local spawnTrainNode = {
    typeName = SPAWN_TRAIN_NODE_TYPE,
    category = "train",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnTrainNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_TRAIN_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnTrainNode
