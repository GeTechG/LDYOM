...
---@class LDNodeEditorSpawnVisualEffectNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_VISUAL_EFFECT_NODE_TYPE = "core.spawn_visual_effect"

---@type LDNodeEditorNodeType
local spawnVisualEffectNode = {
    typeName = SPAWN_VISUAL_EFFECT_NODE_TYPE,
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnVisualEffectNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_VISUAL_EFFECT_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnVisualEffectNode
