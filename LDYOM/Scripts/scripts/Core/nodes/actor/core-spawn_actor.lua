...
---@class LDNodeEditorSpawnActorNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_ACTOR_NODE_TYPE = "core.spawn_actor"

---@type LDNodeEditorNodeType
local spawnActorNode = {
    typeName = SPAWN_ACTOR_NODE_TYPE,
    category = "actor",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnActorNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_ACTOR_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnActorNode
