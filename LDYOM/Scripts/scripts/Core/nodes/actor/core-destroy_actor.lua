...
---@class LDNodeEditorDestroyActorNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local DESTROY_ACTOR_NODE_TYPE = "core.destroy_actor"

---@type LDNodeEditorNodeType
local destroyActorNode = {
    typeName = DESTROY_ACTOR_NODE_TYPE,
    category = "actor",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorDestroyActorNode
        local newNode = {
            id = newNodeId,
            nodeType = DESTROY_ACTOR_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorDestroyActorNode
