...
---@class LDNodeEditorSpawnVehicleNode : LDNodeEditorNode
---@field sceneId integer
---@field entityUuid string

local SPAWN_VEHICLE_NODE_TYPE = "core.spawn_vehicle"

---@type LDNodeEditorNodeType
local spawnVehicleNode = {
    typeName = SPAWN_VEHICLE_NODE_TYPE,
    category = "vehicle",
    ...
    new = function(ctx, newNodeId, getPinId)
        ---@type LDNodeEditorSpawnVehicleNode
        local newNode = {
            id = newNodeId,
            nodeType = SPAWN_VEHICLE_NODE_TYPE,
            buffer = "",
            inputs = {
                {
                    id = getPinId(),
    ...
    ---@param ctx LDNodeEditorContext
    ---@param node LDNodeEditorSpawnVehicleNode
